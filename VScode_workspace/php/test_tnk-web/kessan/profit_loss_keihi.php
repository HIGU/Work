...
$menu->set_title("第 22 期　11 月度　経 費 実 績 内 訳 表");
...
if (isset($_POST['input_data'])) {
    ...
    for ($i = 0; $i < 3; $i++) {
        ...
        $input_data[38]  = str_replace(',','',"700");   // 経費計
        $input_data[39]  = str_replace(',','',"800");   // 合計
        if ($i == 0) {
            $head  = "製造経費";
        } elseif ($i == 1) {
            $head  = "販管費";
...
<?= $menu->out_title_border() ?>
        ...
        <table width='100%' bgcolor='#d6d3ce' align='center' cellspacing="0" cellpadding="3" border='1'>
            <TBODY>
                ...
                <TR>
                    <TD align="center" nowrap height="20" class='pt10b'><?php printf("%s/%s", "2022", "09") ?></TD>
                    <TD align="center" nowrap height="20" class='pt10b'><?php printf("%s/%s", "2022", "10") ?></TD>
                    <TD align="center" nowrap height="20" class='pt10b' bgcolor='#ffffff'><?php printf("%s/%s", "2022", "11") ?></TD>
