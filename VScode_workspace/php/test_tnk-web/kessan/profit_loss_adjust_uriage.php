    ...
    <center>
            ...
            <table bgcolor='#d6d3ce' cellpadding='5' border='1'>
                ...
                <tr>
                    <td align='center' bgcolor='#ffa4a4' class='pt12b'>
                        カプラ売上高調整額<input type='text' name='adjust_c' size='15' maxlength='11' value='<?php echo 900 ?>' class='right'>
                    </td>
                    <td align='center' bgcolor='#ffa4a4' class='pt12b'>
                        リニア売上高調整額<input type='text' name='adjust_l' size='15' maxlength='11' value='<?php echo 900 ?>' class='right'>
                    </td>
                    <td align='center'>　</td> <!-- 余白 -->
                </tr>
                <tr>
                    <td align='left' class='pt11'>
                        Ｃ理由<input type='text' name='reason_c' size='50' maxlength='50' value='<?php echo 900 ?>' class='pt9'>
                    </td>
                    <td align='left' class='pt11'>
                        Ｌ理由<input type='text' name='reason_l' size='50' maxlength='50' value='<?php echo 900 ?>' class='pt9'>
                    </td>
        ...
        <table bgcolor='#d6d3ce' cellpadding='5' border='1'>
            ...
            <tr>
                ...
                <td align='right' class='pt11b'><?php echo 900 ?></td>
                <td align='right' class='pt11b'><?php echo 900 ?></td>
                <td align='right' class='pt11b'><?php echo 900 ?></td>
            </tr>
        </table>
