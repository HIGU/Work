...
<BODY class='margin0' onLoad="set_focus()">
    <center>
            ...
            <table bgcolor='#d6d3ce' cellpadding='5' border='1'>
                ...
                <tr>
                    <td align='center' bgcolor='#ffa4a4' class='pt12b'>
                        カプラ棚卸高調整額<input type='text' name='adjust_c' size='15' maxlength='11' value='<?php echo 500 ?>' class='right'>
                    </td>
                    <td align='center' bgcolor='#ffa4a4' class='pt12b'>
                        リニア棚卸高調整額<input type='text' name='adjust_l' size='15' maxlength='11' value='<?php echo 500 ?>' class='right'>
                    </td>
                    <td align='center'>　</td> <!-- 余白 -->
                </tr>
                <tr>
                    <td align='left' class='pt11'>
                        Ｃ理由<input type='text' name='reason_c' size='50' maxlength='50' value='<?php echo 500 ?>' class='pt9'>
                    </td>
                    <td align='left' class='pt11'>
                        Ｌ理由<input type='text' name='reason_l' size='50' maxlength='50' value='<?php echo 500 ?>' class='pt9'>
                    </td>
        ...
        <table bgcolor='#d6d3ce' cellpadding='5' border='1'>
            ...
            <tr>
                <td align='right' class='pt11b'><?php echo 500 ?></td>
                <td align='right' class='pt11b'><?php echo 500 ?></td>
                <td align='right' class='pt11b'><?php echo 500 ?></td>
            </tr>
        </table>
