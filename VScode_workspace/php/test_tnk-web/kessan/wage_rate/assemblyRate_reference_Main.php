...
function getViewHTMLbody($request, $menu, $result)
{
    ...
    $listTable .= "            <td colspan=7 class=border-none><B><font size = 4>202211迄実績（01 月～ 11 月）</font></B></td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    ...
    $listTable .= "            <td class=machine_rate_title align=center style='border-top:1.0pt solid windowtext'><B>202211</B></td>\n";
    $listTable .= "            <td class=border-on align=center style='border-bottom:none'>202201</td>\n";
    $listTable .= "            <td class=border-on align=center style='border-bottom:none'>202211</td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    ...
    for ($r=0; $r<1; $r++) {
        $g_num = $res_g[$r][0];
        $listTable .= "    <tr>\n";
        for ($i=0; $i<10; $i++) {         // レコード数分繰返し
            $listTable .= "<tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
            $listTable .= "    <td height=20 class=border-none style='height:15.0pt'></td>\n";
            $listTable .= "    <td rowspan=1 colspan=2 class=border-on align=center valign=middle style='border-bottom:none'>test</td>\n";
            $listTable .= "    <td class=border-on style='border-bottom:none'><center>賃</center></td>\n";
            $listTable .= "    <td class=border-on align=right style='border-bottom:none'>100</td>\n";
            ...
            $listTable .= "    <td class=border-on align=right style='border-left:none;border-bottom:none'>100</td>\n";
            ...
            $listTable .= "<tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
            $listTable .= "    <td height=20 class=border-none style='height:15.0pt'></td>\n";
            $listTable .= "<td colspan=2 class=border-on align=center style='border-top:none;border-bottom:none'>1</td>\n";
            $listTable .= "    <td class=border-none><center>減</center></td>\n";
            $listTable .= "    <td class=border-on align=right style='border-top:none;border-bottom:none'>100</td>\n";
            ...
            $listTable .= "    <td class=border-on align=right style='border-top:.5pt dotted windowtext;border-bottom:none'>100</td>\n";
            $listTable .= "    <td class=border-on align=right style='border-top:none;border-bottom:none'>100</td>\n";
            $listTable .= "    <td class=border-on align=right style='border-top:none;border-bottom:none'>10</td>\n";
            $listTable .= "    <td class=border-none>10人 /</td>\n";
            $listTable .= "    <td class=border-none>10人</td>\n";
    ...
    $listTable .= "            <td class=man_expense align=right style='border-left:none;border-top:1.0pt solid windowtext;border-right:1.0pt solid windowtext'>100</td>\n";
    ...
    $listTable .= "            <td class=direct_expense align=right align=right style='border-top:.5pt dotted black;border-bottom:1.0pt solid windowtext;border-left:1.0pt solid windowtext'>100</td>\n";
    $listTable .= "            <td class=border-on align=right style='border-top:none'>100</td>\n";
    $listTable .= "            <td class=border-on align=right style='border-top:none'>10</td>\n";
    ...
    $listTable .= "            <td class=border-none align=right>100</td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    ...
    $listTable .= "            <td class=assist align=right>100</td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    ...
    $listTable .= "            <td class=direct_expense align=right>10</td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    $listTable .= "            <td class=border-none colspan=3>自動組立機作業経費減額</td>\n";
    $listTable .= "            <td class=man_expense align=right>10</td>\n";
    $listTable .= "            <td></td>\n";
    $listTable .= "            <td></td>\n";
    $listTable .= "            <td colspan=3 class=labor_rate_title align=center><B>202211実際賃率</B></td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    $listTable .= "            <td class=border-none align=right colspan=3 style='border-top:1.0pt solid windowtext'>合計</td>\n";
    $listTable .= "            <td class=border-none align=right style='border-top:1.0pt solid windowtext'>112</td>\n";
    $listTable .= "            <td class=border-none align=center>÷</td>\n";
    $listTable .= "            <td class=border-none>Ａ＝</td>\n";
    $listTable .= "            <td class=labor_rate align=right>10</td>\n";
    ...
    $listTable .= "            <td class=assemble align=right>100</td>\n";
    $listTable .= "            <td class=border-none>Ａ</td>\n";
    /*
    $listTable .= "            <td class=assemble align=right>100</td>\n";
    ...
    */
    $listTable .= "            <td></td>\n";
    $listTable .= "            <td colspan=3 class=border-on align=center>202211実際賃率</td>\n";
    $listTable .= "        </tr>\n";
    $listTable .= "        <tr height=20 style='mso-height-source:userset;height:15.0pt'>\n";
    /*
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    ...
    */
    ...
    if ($before_labor_rate_t == "") {
        ...
        $listTable .= "        <td class=border-on align=right>10</td>\n";
    }
    ...
    */
    ...
    $listTable .= "            <td height=20 class=border-none style='height:15.0pt'></td>\n";
    $listTable .= "            <td class=border-none align=right colspan=3 style='border-top:1.0pt solid windowtext'>合計</td>\n";
    $listTable .= "            <td class=border-none align=right style='border-top:1.0pt solid windowtext'>100</td>\n";
    $listTable .= "            <td class=border-none align=center>÷</td>\n";
...
function getInputHTMLbody($request, $menu, $result)
{
    ...
    $listTable .= "            <tr>\n";
    $listTable .= "                <td>　</td>\n";
    $listTable .= "                    <td class='winbox' align='center'><input type='text' class='price_font' name='worker_rate_s' value='10102' size='15'></td>\n";
    $listTable .= "                    <td class='winbox' align='center'><input type='text' class='price_font' name='worker_rate_p' value='10102' size='15'></td>\n";
    $listTable .= "                <td>　</td>\n";
    $listTable .= "            </tr>\n";
    $listTable .= "            <tr>\n";
    $listTable .= "                <td colspan=4 class='winbox' align='center'>\n";
    $listTable .= "                    <input type='submit' class='entry_font' name='entry' value='登録'>\n";
    $listTable .= "                    <input type='hidden' name='rows_g' value='10'>\n";
    $listTable .= "                    <input type='hidden' name='end_ym' value='202201'>\n";
    $listTable .= "                    <input type='hidden' name='str_ym' value='202211'>\n";
    $listTable .= "                </td>\n";
    $listTable .= "            </tr>\n";
    $listTable .= "        </TBODY>\n";
    $listTable .= "        </table>\n";
