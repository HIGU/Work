...
function getViewHTMLbody($request, $menu, $result)
{
    ...
    for ($i=0; $i<count($field_l)-1; $i++) {             // フィールド数分繰返し
    ...
    $res_l = array(
        [1, 1, "dummy", 100,  202201, 100,  202301, ],
        [2, 2, "dummy", 200,  202202, 200,  202302, ],
        [3, 3, "dummy", 300,  202203, 300,  202303, ],
        [4, 4, "dummy", 400,  202204, 400,  202304, ],
        [5, 5, "dummy", 500,  202205, 500,  202305, ],
        [6, 6, "dummy", 600,  202206, 600,  202306, ],
        [7, 7, "dummy", 700,  202207, 700,  202307, ],
        [8, 8, "dummy", 800,  202208, 800,  202308, ],
        [9, 9, "dummy", 900,  202209, 900,  202309, ],
        [10,10,"dummy", 1000, 202210, 1000, 202310, ],
    );
    $group_name_l = array(
        "test1", 
        "test2", 
    ...
    for ($i=0; $i<count($field)-1; $i++) {             // フィールド数分繰返し
    ...
    $listTable .= "            <!-- サンプル<td rowspan='2' colspan='3' width='200' align='center' class='pt10b' bgcolor='#ffffc6'>  </td> -->\n";
    $res = array(
        [1, 1, "dummy", 100,  202201, 1, 10, 202301,],
        [2, 2, "dummy", 200,  202202, 2, 20, 202302,],
        [3, 3, "dummy", 300,  202203, 3, 30, 202303,],
        [4, 4, "dummy", 400,  202204, 4, 40, 202304,],
        [5, 5, "dummy", 500,  202205, 5, 50, 202305,],
        [6, 6, "dummy", 600,  202206, 6, 60, 202306,],
        [7, 7, "dummy", 700,  202207, 7, 70, 202307,],
        [8, 8, "dummy", 800,  202208, 8, 80, 202308,],
        [9, 9, "dummy", 900,  202209, 9, 90, 202309,],
        [10,10,"dummy", 1000, 202210, 1, 10, 202310,],
    );
    $group_name = array(
        "test1", 
        "test2", 
    ...
    for ($i=0; $i<count($group_name); $i++) {             // グループ数分繰返し
        $listTable .= "            <tr>\n";
