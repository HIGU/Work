...
// Changed history                                                          //
// 2021/06/22 Created  equip_work_monimapHeader.php                         //
//////////////////////////////////////////////////////////////////////////////
...
<?= $menu->out_title_border() ?>
        ...
        <table class='winbox_field' width='100%' border='0' cellspacing='0' cellpadding='1'>
            <tr class='sub_font'>
                ...
                <td class='winbox'>
                    <form name='reload_form' action='equip_work_monimapList.php' method='get' target='List'>
                        <input style='font-size:10pt; color:blue;' type='submit' name='reload' value='再表示'>
                        <input type='hidden' name='factory' value='<?=$factory?>'>
                    </form>
                </td>
                <td class='winbox'>
                    <form action='equip_work_moni.php' method='get' target='_parent'>
