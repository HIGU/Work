...
// Copyright (C) 2021-2021 norihisa_ooya@nitto-kohki.co.jp                  //s
// Changed history                                                          //
// 2021/03/26 Created  equip_work_monigraphList.php                         //
//////////////////////////////////////////////////////////////////////////////
...
if ($select == 'GO') {
    ...
    $equip_graph = new EquipGraph($mac_no, $plan_no, $koutei, 180);
...
<body onLoad='init()'>
    <center>
        ...
        <table class='winbox_field' width='100%' border='0' cellspacing='0' cellpadding='2'>
            <tr>
                <td class='winbox' style='font-size:11pt;' nowrap><?=$graphDateTime['strDate'], ' ', $graphDateTime['strTime']?></td>
                <td class='winbox' style='font-size:11pt;' nowrap>～</td>
                <td class='winbox' style='font-size:11pt;' nowrap><?=$graphDateTime['endDate'], ' ', $graphDateTime['endTime']?></td>
                <td class='winbox' style='font-size:11pt;' nowrap>
                    24時間の範囲を表示
                </td>
                <td class='winbox' style='font-size:11pt;' nowrap>表示ページ番号：<?=$graph_page?></td>
            <!--
                <td>
...
<script language='JavaScript'>
<!--
setTimeout('location.replace("equip_work_monigraphList.php?select=<?=$select?>&equip_xtime=<?=$equip_xtime?>")',10000);      // リロード用１０秒
// -->
</script>
<? } ?>
</html>
