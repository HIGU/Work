...
// Changed history                                                          //
// 2021/03/26 Created  equip_work_monigraphHeader.php                       //
//////////////////////////////////////////////////////////////////////////////
...
if ($view == 'OK') {
    ...
    */
    ...
    $query = "select  mac_state
                ...
                from
                    equip_work_log2_moni
                WHERE   plan_no='{$plan_no}' and mac_no={$mac_no} and koutei={$koutei} and to_char((CAST(date_time AS TIMESTAMP)), 'YYYYMMDDHH24MISS') <={$graph_strTime}
                order by
                    date_time DESC
                offset 0 limit 1
    ";
    ...
    */
    ...
    $query = "select  mac_state
                ...
                from
                    equip_work_log2_moni
                WHERE   plan_no='{$plan_no}' and mac_no={$mac_no} and koutei={$koutei} and to_char((CAST(date_time AS TIMESTAMP)), 'YYYYMMDDHH24MISS') <={$graph_endTime}
                order by
                    date_time DESC
                offset 0 limit 1
            ";
...
<Script Language='JavaScript'>
    ...
    document.MainForm.action = 'equip_work_monigraphList.php';
