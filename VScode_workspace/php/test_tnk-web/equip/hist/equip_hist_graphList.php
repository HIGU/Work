<?php
//////////////////////////////////////////////////////////////////////////////
// 機械稼動管理システムの 実績(履歴) グラフ 表示  Graph本体フレーム         //
// Copyright (C) 2004-2005 2007 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp //
// Changed history                                                          //
// 2004/08/19 Created  equip_hist_graphList.php                             //
...
////////////// サイト設定
$menu->set_site(40, 6);                     // site_index=40(設備メニュー) site_id=10(状況表)
////////////// target設定
...
if ($select == 'GO') {
    ...
    /////////// 設備管理グラフのインスタンス作成 標準解像度180(高解像度は360)
    ...
    $graph_name = 'graph/equip_hist_graph.png';
...
<body onLoad='init()'>
    <center>
        ...
        <table width='100%' border='0'>
            <tr><td align='center'>
            <?= "<img src='", $graph_name, "?", uniqid(rand(),1), "' alt='生産数 状態 グラフ' border='0'>\n"; ?>
            </td></tr>
        </table>
