...
// Changed history                                                          //
// 2005/07/16 Created   equip_stopMaster_ViewList.php                       //
...
<script language='JavaScript' src='stopMaster.js?=<?= $uniq ?>'></script>
</head>
    ...
    <tr><td>
        ...
        <?php if ($rows >= 1) { ?>
            ...
            <table class='winbox_field' bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
                ...
                <th class='winbox' nowrap>停止と判断する時間(秒)</th>
