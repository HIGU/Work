...
// Changed history                                                          //
// 2005/07/14 Created   equip_interfaceMaster_ViewApend.php                 //
...
function set_focus() {
    ...
    document.apend_form.inter.focus();
    document.apend_form.inter.select();
}
// -->
</script>
...
<?= $menu->out_title_border() ?>
    ...
    <tr><td>
        ...
        <form name='apend_form' action='<?=$menu->out_self(), '?', $model->get_htmlGETparm(), "&id={$uniq}"?>' method='post' onSubmit='return chk_interfaceMaster(this)'>
            <table bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='5'>
                <caption>インターフェース マスター 追加</caption>
                <tr><td> <!----------- ダミー(デザイン用) ------------>
            <table class='winbox_field' bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
                <tr>
                    ...
                    <td class='winbox' align='left' nowrap>
                        <input type='text' name='inter' size='5' value='<?=$interface?>' maxlength='4' style='text-align:right;'>
                    </td>
                </tr>
                <tr>
