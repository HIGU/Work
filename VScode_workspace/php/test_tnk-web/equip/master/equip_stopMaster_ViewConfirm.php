...
// Changed history                                                          //
// 2005/07/16 Created   equip_stopMaster_ViewConfirm.php                    //
...
<?= $menu->out_title_border() ?>
    ...
    <tr><td>
        ...
        <form name='confirm_form' action='<?=$menu->out_self(), '?', $model->get_htmlGETparm(), "&id={$uniq}"?>' method='post' onSubmit='return chk_stopMaster(this)'>
            <table bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='5'>
                <caption>停止の定義 マスター 確認</caption>
                <tr><td> <!----------- ダミー(デザイン用) ------------>
            <table class='winbox_field' bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
                <tr>
                ...
                <tr>
                    ...
                    <td class='winbox' align='left' nowrap>
                        <input type='text' name='stop' size='5' value='<?=$stop?>' maxlength='4' style='text-align:right;' readonly style='background-color:#d6d3ce;'>
                    </td>
                </tr>
                <tr>
