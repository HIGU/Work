...
// Changed history                                                          //
// 2004/07/01 Created   Materials.php                                       //
...
$menu->set_title('材料マスター');
//////////// フレームの呼出先のアクション(frame)名とアドレス設定
$menu->set_frame('Header', EQUIP2 . 'daily_report_moni/master/MaterialsSearch.php');
$menu->set_frame('List'  , EQUIP2 . 'daily_report_moni/master/MaterialsList.php');
