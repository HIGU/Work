...
$menu->set_frame('Header', EQUIP2 . 'daily_report_moni/business/AbandonmentSearch.php');
$menu->set_frame('List'  , EQUIP2 . 'daily_report_moni/business/AbandonmentList.php');
