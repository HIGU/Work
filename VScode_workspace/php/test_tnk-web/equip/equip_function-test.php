...
// Copyright (C) 2002-2007 Kazuhiro Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
...
define('FWS1', '10.1.3.41');                // 4工場
//                  fws2  fwserver2.tnk.co.jp
define('FWS2', '10.1.3.42');                // 4工場
//                  fws3  fwserver3.tnk.co.jp
define('FWS3', '10.1.3.43');                // 1工場
//                  fws4  fwserver4.tnk.co.jp
define('FWS4', '10.1.3.44');                // 1工場
...
// 与えられた引数(レコード番号)の機械№を返す。なければFALSE
...
// 引数の機械№でヘッダーファイルからログファイル名生成
// ヘッダーファイルに機械№がなければNULL出力
...
// 引数の機械№でヘッダーファイルから指定フィールドを一つ返す
// ヘッダーファイルに機械№がなければNULL出力(エラー時)
