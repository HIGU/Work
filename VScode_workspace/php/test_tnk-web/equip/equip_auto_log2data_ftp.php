...
require_once ('/var/www/html/equip/equip_function.php');

$check_file    = '/var/www/html/equip/check_file';
$auto_log_stop = '/var/www/html/equip/equip_auto_log_stop';    // 2007/06/15 ADD
