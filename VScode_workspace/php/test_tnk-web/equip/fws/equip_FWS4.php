...
$_SESSION['site_id']    = 92;           // 下位メニュー無し <= 0    テンプレートファイルは６０番
...
<script language='JavaScript'>
<!--
location.replace('http://fwserver4.tnk.co.jp/cgi-bin/mon.cgi?argHtmlFile=stsmon4.html');        // 目的のスクリプトを呼出す
// -->
</script>
