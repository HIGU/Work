...
require_once ('../EquipGraphClass_report.php');    // 設備稼働管理 Graph class
...
if (isset($_REQUEST['str_date'])) {
    ...
    $str_date = date('Y/m/d', mktime() - 86400);    // 前日にセット
    $end_date = date('Y/m/d');
}
...
$menu->set_title("{$mac_no}　{$mac_name}　運転 日報 対応 グラフ 表示");
                ...
                <tr>
                    <td>
                        <select name='equip_xtime' class='ret_font' onChange='document.xtime_ctl_left.submit()'>
                            ...
                            <?php } else { ?>
                            <option value='2'  <?php if ($equip_xtime==2) echo 'selected';?>>&nbsp;2時間</option>
                            <option value='4' <?php if ($equip_xtime==4) echo 'selected';?>>&nbsp;4時間</option>
                            <option value='6' <?php if ($equip_xtime==6) echo 'selected';?>>&nbsp;6時間</option>
                            <option value='8' <?php if ($equip_xtime==8) echo 'selected';?>>&nbsp;8時間</option>
                            <option value='10' <?php if ($equip_xtime==10) echo 'selected';?>>10時間</option>
                            <option value='12' <?php if ($equip_xtime==12) echo 'selected';?>>12時間</option>
                            <option value='14' <?php if ($equip_xtime==14) echo 'selected';?>>14時間</option>
                            <option value='16' <?php if ($equip_xtime==16) echo 'selected';?>>16時間</option>
                            <option value='18' <?php if ($equip_xtime==18) echo 'selected';?>>18時間</option>
                            <option value='20' <?php if ($equip_xtime==20) echo 'selected';?>>20時間</option>
                            <option value='22' <?php if ($equip_xtime==22) echo 'selected';?>>22時間</option>
