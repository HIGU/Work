...
// 2006/04/14 削除ボタンの<td>部に </td> が抜けていたのを修正               //
//////////////////////////////////////////////////////////////////////////////
        ...
        <?php } else { ?>
            <table border='1' class='Conversion'>
                <tr class='Conversion'>
                    ...
                    <td class='HED Conversion' width='150'>機能コード</td>
                    <td class='HED Conversion' width=' 80'>社員コード</td>
                    <td class='HED Conversion' width='100'>氏　　名</td>
                </tr>
            <?php while ($row = pg_fetch_array ($rs)) { ?>
                <tr class='Conversion'>
                    <td class='Conversion' align='center'><?php if ($AdminUser) { ?><input type='button' value='削除' onClick='del("<?=outHtml($row['function'])?>","<?=outHtml($row['staff'])?>")'><?php } ?></td>
