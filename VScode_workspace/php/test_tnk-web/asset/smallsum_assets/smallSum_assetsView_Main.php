...
function getViewHTMLbody($request, $menu, $result)
{
    ...
    for ($i=0; $i<count($field_c); $i++) {    // フィールド数分繰返し\n";
    ...
    $res_c = array(
        [1, "test1", "name1", "model1", 20220101, 100, 20220101, "dummy1"],
        [2, "test2", "name2", "model2", 20220201, 200, 20220201, "dummy2"],
        [3, "test3", "name3", "model3", 20220301, 300, 20220301, "dummy3"],
        [4, "test4", "name4", "model4", 20220401, 400, 20220401, "dummy4"],
        [5, "test5", "name5", "model5", 20220501, 500, 20220501, "dummy5"],
        [6, "test6", "name6", "model6", 20220601, 600, 20220601, "dummy6"],
        [7, "test7", "name7", "model7", 20220701, 700, 20220701, "dummy7"],
        [8, "test8", "name8", "model8", 20220801, 800, 20220801, "dummy8"],
        [9, "test9", "name9", "model9", 20220901, 900, 20220901, "dummy9"],
        [10,"test10","name10","model10",20221001, 1000,20221001, "dummy10"],
    );
    for ($r=0; $r<count($res_c); $r++) {
        $listTable .= "        <tr>\n";
        $listTable .= "            <td class='winbox' nowrap align='right'>\n";
        $cnum = $r + 1;
        $listTable .= "                ". $cnum ."\n";
        $listTable .= "            </td>    <!-- 行ナンバーの表示 -->\n";
        for ($i=0; $i<count($field_c); $i++) {    // レコード数分繰返し
            switch ($i) {
                case 0:                                 // 管理部門
