<?php
//////////////////////////////////////////////////////////////////////////////
// 社員情報管理の 社員名簿 部署別一覧表 ＰＤＦ出力(印刷) FPDF/FPDF-JA使用   //
// Copyright (C) 2004-2017 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2004/02/13 Created  print_emp_section_ja.php  明朝体                     //
...
require('/var/www/html/fpdf184/japanese.php');
define('FPDF_FONTPATH', '/var/www/html/mbfpdf/font/');     // Core Font のパス
...
///// PDF文書のプロパティ設定
$pdf->SetAuthor('Tochigi Nitto Kohki Co.,Ltd. k.kobayashi');
