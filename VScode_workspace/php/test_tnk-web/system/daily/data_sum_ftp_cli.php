...
//            よりノーツのルール(フィルター)にヒットしないため UTF-8→JIS  //
//////////////////////////////////////////////////////////////////////////////
...
// 保存先のディレクトリとファイル名
define('S_FILE', '/var/www/html/system/backup/data_sum.log');  // save file
...
define('LOCAL_NAME', '/var/www/html/system/daily/data_sum_ctl.dat');   // コントロールファイルのローカル名
...
$file_orign  = S_FILE;
$file_nippo  = '/var/www/html/system/backup/data_sum_nippo.log';
