...
// 計算ルール ①前半期の買掛と標準部品番号を抜き出し                        //
//            ②前半期の特注・標準出庫量を抜出し、特注の出庫率を計算        //
...
fwrite($fpb, "/var/www/html/system/daily/ctoku_allocation_cal.php\n");
echo "/var/www/html/system/daily/ctoku_allocation_cal.php\n";
