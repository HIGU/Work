...
fwrite($fpb, "/var/www/html/system/daily/daily_miccc_ftp_cli.php\n");

// FTPのターゲットファイル
$target_file = 'UKWLIB/W#MICCC';        // download file
// 保存先のディレクトリとファイル名
$save_file = '/var/www/html/system/backup/W#MICCC.TXT';     // save file
...
$file_debug  = '/var/www/html/system/debug/debug-MICCC.TXT';
