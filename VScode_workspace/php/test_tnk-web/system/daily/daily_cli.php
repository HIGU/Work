...
echo "************************************************************************\n";
echo "日報(daily)処理\n";
echo "/var/www/html/system/daily/daily_cli.php\n";
echo "************************************************************************\n";
...
/******** アイテムマスターの更新 *********/
echo "アイテムマスターの更新\n";
echo "/var/www/html/system/daily/daily_miitem_cli.php\n";
echo `/var/www/html/system/daily/daily_miitem_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** ＣＣ部品ＴＮＫＣＣ部品のテーブル更新 *********/
echo "ＣＣ部品ＴＮＫＣＣ部品のテーブル更新\n";
echo "/var/www/html/system/daily/daily_miccc_ftp_cli.php\n";
echo `/var/www/html/system/daily/daily_miccc_ftp_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** Ａ伝情報の更新 *********/
echo "Ａ伝情報の更新\n";
echo "/var/www/html/system/daily/daily_aden_cli.php\n";
echo `/var/www/html/system/daily/daily_aden_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** Ａ伝詳細情報の更新 *********/
echo "Ａ伝詳細情報の更新\n";
echo "/var/www/html/system/daily/daily_aden_details_cli.php\n";
echo `/var/www/html/system/daily/daily_aden_details_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** 在庫経歴・在庫マスター前日分の更新(残業時間18:00以降の対応) *********/
echo "在庫経歴・在庫マスター前日分の更新(残業時間18:00以降の対応)\n";
echo "/var/www/html/system/daily/parts_stock_history_master_ftp_cli3.php\n";
echo `/var/www/html/system/daily/parts_stock_history_master_ftp_cli3.php`;
echo "------------------------------------------------------------------------\n";

/******** 日次部品棚卸金額の更新 *********/
echo "日次部品棚卸金額の更新\n";
echo "/var/www/html/system/daily/daily_stock_cli.php\n";
echo `/var/www/html/system/daily/daily_stock_cli.php`;
echo "------------------------------------------------------------------------\n";
...
/******** 組立工程マスターの自動登録 *********/
echo "組立工程マスターの自動登録\n";
echo "/var/www/html/system/assembly_time/assembly_process_master_cli_once.php\n";
echo `/var/www/html/system/assembly_time/assembly_process_master_cli_once.php`;
echo "------------------------------------------------------------------------\n";

/******** 仕切単価の更新 *********/
echo "仕切単価の更新\n";
echo "/var/www/html/system/daily/sales_price_update_cli.php\n";
echo `/var/www/html/system/daily/sales_price_update_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** 不適合処置連絡書の更新 *********/
echo "不適合処置連絡書の更新\n";
echo "/var/www/html/system/daily/claim_disposal_details_update_cli.php\n";
echo `/var/www/html/system/daily/claim_disposal_details_update_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** 単価レート区分マスターの更新 *********/
echo "単価レート区分マスターの更新\n";
echo "/var/www/html/system/daily/parts_ratediv_master_update_ftp.php\n";
echo `/var/www/html/system/daily/parts_ratediv_master_update_ftp.php`;
echo "------------------------------------------------------------------------\n";

/******** 部品単価レート経歴マスターの更新 *********/
echo "部品単価レート経歴マスターの更新\n";
echo "/var/www/html/system/daily/parts_rate_history_update_ftp.php\n";
echo `/var/www/html/system/daily/parts_rate_history_update_ftp.php`;
echo "------------------------------------------------------------------------\n";

/******** 有給休暇取得情報の更新 *********/
echo "有給休暇取得情報の更新\n";
echo "/var/www/html/system/daily/daily_yukyu_cli.php\n";
echo `/var/www/html/system/daily/daily_yukyu_cli.php`;
echo "------------------------------------------------------------------------\n";

/******** 月初売上予定の保管 *********/
echo "月初売上予定の保管\n";
echo "/var/www/html/system/daily/sales_actual_set_plan.php\n";
echo `/var/www/html/system/daily/sales_actual_set_plan.php`;
echo "------------------------------------------------------------------------\n";
?>
