...
fwrite($fpb, "/var/www/html/system/daily/product_code_get_ftp.php \n");

// FTPのターゲットファイル
define('MSHMAS', 'UKWLIB/W#MSHMAS');        // 製品グループコードファイル
define('W_MSHMAS', '/var/www/html/system/backup/W#MSHMAS.TXT');  // 製品グループコードのDownloadファイル
...
// 製品グループコード 日報処理
$file_name = '/var/www/html/system/backup/W#MSHMAS.TXT';
$file_name_bak = '/var/www/html/system/backup/W#MSHMAS-bak.txt';
