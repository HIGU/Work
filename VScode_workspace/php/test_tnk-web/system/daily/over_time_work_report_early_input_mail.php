...
<?php
//////////////////////////////////////////////////////////////////////////////
// 定時間外作業申告【早出】残業結果報告情報メール送信 cron.d tnk_daily 処理で実行//
// 月～金の指定時にメール送信 全体版 【早出】残業結果報告情報を承認者へ定期メール   //
...
fwrite($fpb, "定時間外作業申告【早出】残業結果報告情報メール送信\n");
...
if ($con = db_connect()) {
    ...
    echo "$log_date 定時間外作業申告【早出】残業結果報告情報メール送信 db_connect() error \n";
    fwrite($fpa,"$log_date 定時間外作業申告【早出】残業結果報告情報メール送信 db_connect() error \n");
    fwrite($fpb,"$log_date 定時間外作業申告【早出】残業結果報告情報メール送信 db_connect() error \n");
    exit();
}
