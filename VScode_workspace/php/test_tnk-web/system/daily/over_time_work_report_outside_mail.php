...
<?php
//////////////////////////////////////////////////////////////////////////////
// 定時間外作業申告【通常・休出】規程外情報送信 cron.d tnk_daily 処理で実行 //
// 月～金の指定時にメール送信 全体版                                        //
//                           【通常・休出】規程外情報を承認者へ定期メール   //
// Copyright (C) 2022-2022 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2022/04/11 Created   over_time_work_report_outside_mail.php              //
//////////////////////////////////////////////////////////////////////////////
...
fwrite($fpb, "定時間外作業申告【通常・休出】規程外情報メール送信\n");
...
if ($con = db_connect()) {
    ...
    echo "$log_date 定時間外作業申告【通常・休出】規程外情報送信 db_connect() error \n";
    fwrite($fpa,"$log_date 定時間外作業申告【通常・休出】規程外情報送信 db_connect() error \n");
    fwrite($fpb,"$log_date 定時間外作業申告【通常・休出】規程外情報送信 db_connect() error \n");
    exit();
}
