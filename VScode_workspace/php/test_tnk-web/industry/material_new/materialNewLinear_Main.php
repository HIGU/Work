<?php
//////////////////////////////////////////////////////////////////////////////
// リニア改定仕切単価登録・照会画面 Main部                                  //
// Copyright (C) 2010-2021 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2010/05/13 Created  materialNewLinear_Main.php                           //
// 2010/05/26 タイトルが間違っていたので修正View→Main                      //
...
$menu->set_title('リニア改定仕切単価登録・照会画面');
//////////// 表題の設定
$cap_set= "リニア改定仕切単価登録・照会画面　(リニアで{$str_y}年{$str_m}月から{$end_y}年{$end_m}月までの売上製品が対象)<br>総材料費登録日の青色表示は生産計画は無いが最新の総材料費に見直したもの(クリックで明細表示)"; 
...
<?php
echo "<iframe hspace='0' vspace='0' frameborder='0' scrolling='yes' src='materialNewLinear_ViewHeader.html?{$uniq}' name='header' align='center' width='98%' height='46' title='項目'>\n";
echo "    項目を表示しています。\n";
echo "</iframe>\n";
echo "<iframe hspace='0' vspace='0' frameborder='0' scrolling='yes' src='materialNewLinear_ViewBody.php?", $_SERVER['QUERY_STRING'], "&{$uniq}#mark' name='list' align='center' width='98%' height='80%' title='一覧'>\n";
echo "    一覧を表示しています。\n";
echo "</iframe>\n";
?>
</center>
