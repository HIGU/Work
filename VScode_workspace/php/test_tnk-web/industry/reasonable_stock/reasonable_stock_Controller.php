<?php
//////////////////////////////////////////////////////////////////////////////
// 適正在庫数の照会 直近三年間の出荷数÷３×２           MVC Controller 部  //
// Copyright (C) 2008 Norihisa.Ohya usoumu@nitto-kohki.co.jp                //
// Changed history                                                          //
// 2008/06/17 Created   reasonable_stock_Controller.php                     //
//////////////////////////////////////////////////////////////////////////////
...
class ReasonableStock_Controller
{
    ///// Private properties
    ...
    ************************************************************************/
    ...
    public function __construct($menu)
    {
        ...
        $this->model = new ReasonableStock_Model($this->request);
    }
    ...
    public function display()
    {
        ...
        case 'Both':                                        // フォームとAjax用List(ViewCondForm.phpで処理)
            require_once ('reasonable_stock_ViewCondForm.php');
            break;
        ...
        case 'Comment':                                     // 別ウィンドウでコメントの照会・編集
            ...
            require_once ('reasonable_stock_ViewEditComment.php');
            break;
        case 'List':                                        // Ajax用 List表示
            ...
            require_once ('reasonable_stock_ViewList.php');
            break;
        }
    }
