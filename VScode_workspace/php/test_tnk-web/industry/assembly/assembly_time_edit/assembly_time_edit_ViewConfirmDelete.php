...
// Changed history                                                          //
// 2005/12/14 Created   assembly_time_edit_ViewConfirmDelete.php            //
//////////////////////////////////////////////////////////////////////////////
?>
<!DOCTYPE html>
<html>
...
<?= $menu->out_title_border() ?>
    ...
    <?php if ($rows >= 1) { ?>
        ...
        <form name='Confirm_form' action='<?=$menu->out_self(), "?showMenu=List&{$pageParameter}"?>' method='post'>
            ...
            <tr>
                <td class='winbox pg12b' align='center' colspan='3'>
                    <input type='submit' name='Delete' value='削除' class='pt12b' style='color:red;'
                        onClick='return confirm("削除を実行すると元へは戻せません！\n\n宜しいですか？");'
                    >
                    &nbsp; &nbsp;
