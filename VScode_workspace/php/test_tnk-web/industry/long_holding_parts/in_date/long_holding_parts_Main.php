<?php
//////////////////////////////////////////////////////////////////////////////
// 長期滞留部品の照会 最終入庫日指定で現在在庫がある物  Client interface 部 //
...
// 2007/02/21 parts/からparts/parts_stock_history/parts_stock_view.phpへ変更//
...
require_once ('long_holding_parts_Controller.php');     // MVC の Controller部
require_once ('long_holding_parts_Model.php');          // MVC の Model部
