<?php
//////////////////////////////////////////////////////////////////////////////
// 受入検査の時間・件数の集計･分析 結果 照会          Client interface 部   //
//   Acceptance inspection of analyze.          MVC Controller の Main 部   //
// Copyright (C) 2006-2006 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2006/08/03 Created   acceptance_inspection_analyze_Main.php              //
...
require_once ('acceptance_inspection_analyze_Controller.php');   // MVC の Controller部
require_once ('acceptance_inspection_analyze_Model.php');        // MVC の Model部
...
function main()
{
    ...
    //////////// コントローラー部のインスタンス生成
    $controller = new AcceptanceInspectionAnalyze_Controller($menu);
