...
// (QUERYで一括 スポット)     AS/400 ----> Web Server (PHP)   cli(cron)版   //
// Copyright (C) 2004-2004 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2004/11/01 Created  order_data_truncation_update_spot.php                //
//////////////////////////////////////////////////////////////////////////////
...
// FTPのターゲットファイル
$target_file = 'ASQFG03734/W#CUT';       // 打切トランザクションファイル download file
// 保存先のディレクトリとファイル名
$save_file = '/var/www/html/industry/order/backup/W#TIUCHI.TXT';     // 注文書打切ファイル save file
...
$file_debug  = '/var/www/html/industry/order/backup/debug-TIUCHI.TXT';
