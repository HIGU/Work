//////////////////////////////////////////////////////////////////////////////
// 総材料費の比較(売上高) JavaScript uriage.js → salse_form.js             //
//  Copyright(C)2011-     N.Ohya norihisa_ooya@nitto-kohki.co.jp            //
// 変更経歴                                                                 //
// 2011/05/30 Created material_compare_sale_form.js                         //
// 2011/06/22 画面印刷に対応の為色々いじった                                //
//////////////////////////////////////////////////////////////////////////////
...
function chk_sales_form(obj) {
    ...
    if (!obj.first_ym.value.length) {
        alert("基準年月が入力されていません。");
        obj.first_ym.focus();
        return false;
    }
    if (!isDigit(obj.first_ym.value)) {
        alert("基準年月に数字以外のデータがあります。");
        obj.first_ym.focus();
        obj.first_ym.select();
        return false;
    }
