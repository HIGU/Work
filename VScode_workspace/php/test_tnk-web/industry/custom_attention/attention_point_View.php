<?php
//////////////////////////////////////////////////////////////////////////////
// 特注カプラ冶具・作業注意点照会  attention_point_View.php                 //
// Copyright (C) 2013-2013 Norihisa.Ooya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2013/01/31 Created  attention_point_View.php                             //
//////////////////////////////////////////////////////////////////////////////
...
if (isset($_GET['assy_no'])) {
    $_SESSION['assy_no'] = $_GET['assy_no'];                 // 製品番号をセッションに保存
}
...
////////////// リターンアドレス設定
$menu->set_RetUrl('http:' . WEB_HOST . 'industry/custom_attention/attention_point_Main.php');             // 通常は指定する必要はない
...
$query = "
        ...
        WHERE assy_no = '{$assy_no}' and publish_no = '{$publish_no}'
        ORDER BY
            parts_no
    ";
...
if (($rows = getResultWithField2($query, $field, $res)) <= 0) {
    $_SESSION['s_sysmsg'] = "不適合処置連絡書の登録がありません！{$assy_no} {$publish_no}";
} else {
    $publish_no     = $res[0][0];
...
<script type='text/javascript' language='JavaScript' src='custom_attention.js'></script>
</head>
<center>
