<?php
//////////////////////////////////////////////////////////////////////////////
// 特注カプラ不適合処置連絡書 照会 条件選択フォーム                         //
// Copyright(C) 2013-2016 Norihisa.Ohya nirihisa_ooya@nitto-kohki.co.jp     //
// Changed history                                                          //
// 2013/01/30 Created   claim_disposaln_form.php                            //
// 2013/02/04 captionの文字を変更                                           //
...
$_SESSION['various_referer'] = 'form';
//////////// タイトル名(ソースのタイトル名とフォームのタイトル名)
$menu->set_title('不適合処置連絡書 照会');
//////////// 表題の設定
...
<script type='text/javascript' src='./claim_disposal.js?<?php echo $uniq ?>'>
</script>
...
<?php echo $menu->out_title_border()?>
        ...
        <form name='custom_form' action='claim_disposal_Main.php' method='post' onSubmit='return chk_custom_form(this)'>
            <!----------------- ここは 本文を表示する ------------------->
        ...
        <BR>
        <B>※　製品番号は前方一致検索になります。<BR>
           　　例) CA80424 → CA80424<FONT COLOR='red'>-0</FONT>,CA80424<FONT COLOR='red'>-1</FONT>, CA80424<FONT COLOR='red'>-2</FONT>・・・と検索されます。</B>
    </center>
</body>
