...
// Copyright (C) 2009 Norihisa.Ooya usoumu@nitto-kohki.co.jp                //
// Changed history                                                          //
// 2009/11/24 Created  assemblyRate_machineWork_View.php                    //
// 2009/11/26 設定解除機能を追加（念のため）                                //
//////////////////////////////////////////////////////////////////////////////
?>
<!DOCTYPE html>
<html>
...
<body scroll=no>
    ...
    <form name='entry_form' method='post' action='product_groupMaster_Main.php' onSubmit='return chk_entry(this)'>
        <table bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
            ...
            <table class='winbox_field' width='100%' bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
                ...
                <tr>
                    <td class='winbox' align='center'><input type='text' class='10pt' name='mhgcd' value='<?php echo $request->get('mhgcd') ?>' size='5' maxlength='3' readonly></td>
                    <td class='winbox' align='center'><input type='text' class='10pt' name='mhgnm' value='<?php echo $request->get('mhgnm') ?>' size='30' readonly></td>
