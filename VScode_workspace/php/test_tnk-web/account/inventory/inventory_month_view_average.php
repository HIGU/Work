...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "　合計= 400 円　金額順　400点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>400</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>400</div></td>\n";
                            break;
                        case 11:
                            ...
                            break;
                        case 12:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>40000</center></div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>400</div></td>\n";
                        }
