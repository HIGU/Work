...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "　合計=900円　金額順　900点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 1:     // 部品名
                            ...
                            break;
                        case 2:     // 特注率
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>900</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>900</div></td>\n";
                            break;
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>9000</center></div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>900</div></td>\n";
                        }
