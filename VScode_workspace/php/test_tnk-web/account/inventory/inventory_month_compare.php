...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "<BR>当月　金額=1000円　　1000点 <BR>前月　金額=1000円　　1000点 <BR>差額　金額=0円　　0点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1000</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1000</div></td>\n";
                            break;
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>1000</center></div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1000</div></td>\n";
                        }
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 0:     // 部品番号にリンクを追加
                            ...
                            break;
                        case 1:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'>test{$r}_2</div></td>\n";
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1000</div></td>\n";
                            break;
