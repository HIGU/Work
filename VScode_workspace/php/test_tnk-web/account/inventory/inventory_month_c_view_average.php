...
// Changed history                                                          //
// 2010/02/24 Created   inventory_month_c_view_average.php                  //
...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "　合計=　500円　金額順　500点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>500</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>500</div></td>\n";
                            break;
                        case 11:
                            ...
                            break;
                        case 12:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>50000</center></div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>500</div></td>\n";
                        }
