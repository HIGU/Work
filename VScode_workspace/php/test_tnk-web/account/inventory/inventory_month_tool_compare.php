...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "<BR>当月　金額=1400円　　1400点 <BR>前月　金額=1400円　　1400点 <BR>差額　金額=0円　　0点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1400</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1400</div></td>\n";
                            break;
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>1400</center></div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1400</div></td>\n";
                        }
