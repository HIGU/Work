...
// Changed history                                                          //
// 2003/11/21 Created   inventory_month_view.php                            //
//            SERIAL型のインデックスを作成し SQLを高速化した                //
// 2003/12/04 テーブルをmonth_end→inventory_monthlyへ変更                  //
// 2003/12/10 合計金額と maxrows を inventory_monthly_header から取得       //
...
////////////// サイト設定
$menu->set_site(20, 21);                    // site_index=20(経理メニュー) site_id=21(棚卸合計金額と明細)
////////////// リターンアドレス設定
// $menu->set_RetUrl(INDUST_MENU);             // 通常は指定する必要はない
//////////// タイトル名(ソースのタイトル名とフォームのタイトル名)
$menu->set_title('棚卸データの照会 ＆ チェック');
//////////// 呼出先のaction名とアドレス設定
...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "　合計=300円　金額順　300  点 \n";
            ...
            <TBODY>
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        switch ($i) {
                        case 0:     // 部品番号にリンクを追加
                            echo "<td class='winbox' nowrap align='center'><div class='pt9'><a class='link' href='javascript:void(0)' onClick='win_open(\"{$menu->out_action('在庫経歴')}?targetPartsNo=" . urlencode($res[$r][$i]) . "&noMenu=yes\");' target='_self' style='text-decoration:none;'>3</a></div></td>\n";
                            break;
                        case 1:
                        ...
                        case 4:
                        case 7:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>300</div></td>\n";
                            break;
                        case 5:
                        case 6:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>300</div></td>\n";
                            break;
                        default:
                            echo "<td class='winbox' nowrap align='center'><div class='pt9'>300</div></td>\n";
                        }
                    }
                    ?>
                    </tr>
