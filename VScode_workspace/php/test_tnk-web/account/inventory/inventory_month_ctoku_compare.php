...
//////////// 表題の設定
$caption = "{$act_ym}　" . $menu->out_title() . "<BR>当月　金額=1300円　　1300点 <BR>前月　金額=1300円　　1300点 <BR>差額　金額=0円　　0点 \n";
                ...
                ?>
                    ...
                    for ($i=0; $i<count($field); $i++) {         // レコード数分繰返し
                        ...
                        case 0:     // 部品番号にリンクを追加
                            ...
                            break;
                        case 1:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'>test_{$r}</div></td>\n";
                            break;
                        case 2:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1300</div></td>\n";
                            break;
                        case 3:
                            echo "<td class='winbox' nowrap align='right'><div class='pt9'>1300</div></td>\n";
                            break;
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>1300</center></div></td>\n";
                            break;
                        case 10:
                            echo "<td class='winbox' nowrap align='left'><div class='pt9'><center>1300/center></div></td>\n";
                            break;
