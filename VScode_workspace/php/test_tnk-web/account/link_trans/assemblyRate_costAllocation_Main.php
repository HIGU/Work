...
function getViewHTMLbody($request, $menu, $result)
{
    ...
    if ($result->get('num_c') > 0) {
        ...
        $listTable .= "            <th class='winbox' nowrap>対象グループ</th>\n";
        $listTable .= "            <th class='winbox' nowrap>外注費</th>\n";
        $listTable .= "            <th class='winbox' nowrap>外注ASSY費</th>\n";
        $listTable .= "            <th class='winbox' nowrap>直接費</th>\n";
    }
    $listTable .= "            </tr>\n";
    $listTable .= "        </THEAD>\n";
    $listTable .= "        <TFOOT>\n";
