//////////////////////////////////////////////////////////////////////////////
// 経費内訳の分析用グラフ作成メニュー          MVC View部(JavaScriptクラス) //
...
function graphCreate()
{
    ...
    ************************************************************************/
    ...
    graphCreate.prototype.checkConditionForm = function (obj)
    {
        ...
        if (obj.g1plot1.value == "noItem" || obj.g1plot1.value == "blank") {
            alert("グラフ１のプロット１は必ず指定して下さい。");
            obj.g1plot1.focus();
            return false;
        }
        if ((obj.g2plot2.value != "noItem" && obj.g2plot2.value != "blank") && (obj.g2plot1.value == "noItem" || obj.g2plot1.value == "blank")) {
            alert("グラフ２のプロット１を先に指定して下さい。");
            obj.g2plot1.focus();
            return false;
        }
        if ((obj.g3plot2.value != "noItem" && obj.g3plot2.value != "blank") && (obj.g3plot1.value == "noItem" || obj.g3plot1.value == "blank")) {
