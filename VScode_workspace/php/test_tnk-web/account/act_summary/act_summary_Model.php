    ...
    private function getViewHTMLbody($session, $menu)
    {
        ...
        for ($i=0; $i<5; $i++) {
            if ($expenseFlg == 0) {
                ...
                $listTable .= "        <td class='winbox total' width='12%' align='right' >100</td>\n";   // 前期平均 経費の小計
                $listTable .= "        <td class='winbox total' width='12%' align='right' >100</td>\n";   // 今期平均 経費の小計
                $listTable .= "        <td class='winbox target' width='12%' align='right' >100</td>\n"; // 経費の小計
                $listTable .= "        <td class='winbox total' width='14%' align='right' >100</td>\n"; // 累計 経費の小計
                $listTable .= "        <td class='winbox total' width='14%' align='right' >100</td>\n"; // 半期累計 経費の小計
                $listTable .= "    </tr>\n";
                $expenseFlg = 1;
            }
            ...
            *****/
            // $listTable .= "    <tr style='visibility:hidden;'>\n";の方法で隠す事も可能
                ...
                $listTable .= "        <td class='winbox' width=' 6%' align='right' >dummy".$i."</td>\n";     // 科目
                $listTable .= "        <td class='winbox' width=' 6%' align='left'  >dummy".$i."</td>\n";     // 内訳科目
                $listTable .= "        <td class='winbox' width='20%' align='left'  >dummy".$i."</td>\n";     // 科目名
                $listTable .= "        <td class='winbox' width='12%' align='right' >100</td>\n";// 前期平均
                $listTable .= "        <td class='winbox' width='12%' align='right' >100</td>\n";// 今期平均
                $listTable .= "        <td class='winbox target' width='12%' align='right' >100</td>\n";// 金額
                $listTable .= "        <td class='winbox' width='14%' align='right' >100</td>\n";// 累計
                $listTable .= "        <td class='winbox' width='14%' align='right' >100</td>\n";// 半期累計
                $listTable .= "    </tr>\n";
        }
        $listTable .= "    <tr>\n";
