<?php
//////////////////////////////////////////////////////////////////////////////
// 発注先マスターの照会 ＆ チェック用  更新元 UKWLIB/W#MIWKCK               //
...
// 2008/07/24 表題の年月日表示を処理日から更新年月日へ変更             大谷 //
//////////////////////////////////////////////////////////////////////////////
...
if (($rows = getResultWithField2($query, $field, $res)) <= 0) {
    $_SESSION['s_sysmsg'] .= '発注先マスターのデータがありません!';
...
//////////// 表題の設定
$menu->set_caption($res[0][7] . '現在' . '　' . $menu->out_title());
