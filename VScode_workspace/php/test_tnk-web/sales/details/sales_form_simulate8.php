...
// 2007/11/02 新旧仕切単価(2007/10/01)の差額明細用にsales_form.phpを改造    //
// 2008/10/29 新旧仕切単価(2008/10/01)の差額明細用に                        //
//            sales_form5.phpを改造                                    大谷 //
// 2011/04/05 新旧仕切単価(2011/04/01)の差額明細用に改造               大谷 //
// 2011/04/25 売上区分を完成のみに変更                                 大谷 //
...
//////////// 呼出先のaction名とアドレス設定
$menu->set_action('売上明細',   SALES . 'details/sales_view_simulate8.php');
...
if ( isset($_SESSION['s_standard_date']) ) {
...
<?php echo $menu->out_title_border()?>
        ...
        <form name='uri_form' action='<?php echo $menu->out_action('売上明細')?>' method='post' onSubmit='return chk_sales8_form(this)'>
            <!----------------- ここは 本文を表示する ------------------->
            ...
            <table class='winbox_field' width='100%' bgcolor='#d6d3ce' border='1' cellspacing='0' cellpadding='3'>
                ...
                <tr>
                 ...
                 <tr>
                    <td class='winbox' align='right'>
                        仕切基準日付を指定して下さい(必須)<BR>
                        入力日付以前の最新の仕切を取得します。
                    </td>
                    <td class='winbox' align='center'>
                        <input type="text" name="standard_date" size="9" value="<?php echo($standard_date); ?>" maxlength="8">
                    </td>
                </tr>
                <tr>
                    <td class='winbox' align='right'>
