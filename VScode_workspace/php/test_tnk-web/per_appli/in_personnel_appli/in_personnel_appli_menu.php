...
<!-- 2022/06/08 Delete End. -->
        <tr class='layout'>
            <!-- 2022/06/08 Add Start. -->
...
<!-- 2022/06/08 Delete End. -->
        ...
        <tr class='layout'>
            ...
            <td class='layoutb' id='start' nowrap>
                ...
                <a href="download_file.php/病欠申告書.doc">病欠申告書</a>
                -->
                <a href="download_file.php/22.06@161ﾏｲｶｰ通勤手当（変更）届 .xlsx">マイカー通勤手当（変更）届</a><BR>
                　　　　　　　　　（社員用）
                <BR>
                <a href="download_file.php/22.06@161パート通勤状況届 .xlsx">パート通勤状況届</a><BR>
                　　　　　　　　　（パート社員用）
            </td>
            <td class='layout' id='start'>
            全員提出
            ...
            <td class='layout' id='start'>
            毎月単価変更の見直しにより、金額が変わります。<B><font color='red'>'22/06更新</font></B>
            </td>
        </tr>
        <tr class='layout'>
            <td class='layoutg' id='start'>
