...
// Changed history                                                          //
// 2014/09/19 Created  child_care_appli_menu.php                            //
    ...
    <table class='layout'>
        ...
        <tr class='layout'>
            ...
            <td class='layoutb' id='start'>
                育児休業申請書
                <!-- <a href="download_file.php/131004総合届（改訂2）.xls">育児休業申請書</a> -->
            </td>
        ...
        <tr class='layout'>
            ...
            <td class='layoutb' id='start'>
                育児休業延長・短縮申出書
                <!-- <a href="download_file.php/131004総合届（改訂2）.xls">育児休業延長・短縮申出書</a> -->
            </td>
            <td class='layout' id='start'>
            　
            </td>
        ...
        <tr class='layout'>
            ...
            <td class='layoutb' id='start'>
                育児短時間勤務申請書
                <!-- <a href="download_file.php/131004総合届（改訂2）.xls">育児短時間勤務申請書</a> -->
            </td>
            <td class='layout' id='start'>
            　
            </td>
        ...
        <tr class='layout'>
            ...
            <td class='layoutb' id='start'>
                子の看護のための休暇請求書
                <!-- <a href="download_file.php/131004総合届（改訂2）.xls">子の看護のための休暇請求書</a> -->
            </td>
            <td class='layout' id='start'>
            　
            </td>
