...
// Changed history                                                          //
// 2010/01/26 Created   progMaster_input_ViewApend.php                      //
//////////////////////////////////////////////////////////////////////////////
...
<body onLoad='ProgMaster.setFocus(document.apend_form.pid, "select")'>
<center>
<?= $menu->out_title_border() ?>
    ...
    <form name='apend_form' action='<?=$menu->out_self(), '?', $model->get_htmlGETparm(), "&id={$uniq}"?>' method='post' onSubmit='return ProgMaster.CheckItemMaster(this)'>
        <table bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='5'>
            <caption>プログラム マスター 追加a</caption>
            <tr><td> <!----------- ダミー(デザイン用) ------------>
        <table class='winbox_field' bgcolor='#d6d3ce' align='center' border='1' cellspacing='0' cellpadding='3'>
            <tr>
