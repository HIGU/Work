...
fwrite($fpb, "/home/www/html/tnk-web/system/inventory_average/inventory_average_summary_ftp_cli.php\n");
...
if (file_exists($file_orign)) {         // ファイルの存在チェック
    ...
    while (($data = fgetcsv($fp, 100, '_')) !== FALSE) {    // デリミタはアンダーバーに注意
        ...
        for ($f=0; $f<$num; $f++) {
            $data[$f] = mb_convert_encoding($data[$f], 'EUC-JP', 'AUTO');       // SJISをEUC-JPへ変換
