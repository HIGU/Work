...
function acceptance_inspection_analyze()
{
    ...
    ************************************************************************/
    ...
    acceptance_inspection_analyze.prototype.checkExecute = function (obj)
    {
        ...
        // Ajax通信
        this.AjaxLoadTable("GraphLeadTime", "Graph", "showAjax");
    }
...
{
    AcceptanceInspectionAnalyze.set_focus(document.ConditionForm.targetDateStr, "noSelect");
...
function catchEventListener(evtObj)
{
    ...
    case "targetDateYM":
        ...
        return false;
    case "ConditionForm":
        AcceptanceInspectionAnalyze.checkExecute(document.ConditionForm);
        return false;
    case "showWin":
    ...
    case "addDivision":
        ...
        // Ajax用パラメーターをセット
        AcceptanceInspectionAnalyze.parameter  = "&targetAuthName="   + targetAuthName.value;
        // Ajax通信
        // var url = "acceptance_inspection_analyze_Main.php?Action=AddDivision&showMenu=ListDivision&targetAuthName=" + targetAuthName.value;
        // AcceptanceInspectionAnalyze.AjaxLoadUrl(url, "showAjax1");
        AcceptanceInspectionAnalyze.AjaxLoadTable("AddDivision", "ListDivision", "showAjax1");
        return false;
    case "addIDForm":
    case "addID":
        // 入力項目のチェック
        ...
        // Ajax用パラメーターをセット
        AcceptanceInspectionAnalyze.parameter  = "&targetID="   + targetID.value;
        AcceptanceInspectionAnalyze.parameter  += "&targetDivision="   + document.getElementById("targetDivision").value;
        AcceptanceInspectionAnalyze.parameter  += "&targetCategory="   + targetCategory.value;
        // Ajax通信
        AcceptanceInspectionAnalyze.AjaxLoadTable("AddID", "ListID", "showAjax2");
        return false;
    case "targetID":
        // 入力項目のチェック
        ...
        // Ajax用パラメーターをセット
        AcceptanceInspectionAnalyze.parameter  = "&targetID="   + document.getElementById("targetID").value;
        // Ajax通信
        AcceptanceInspectionAnalyze.AjaxLoadTable("ConfirmID", "ListCategory", "showCateList");
        return false;
    case "targetCategory":
        // 入力項目のチェック
        if (!document.getElementById("targetID").value) {
        ...
        // Ajax用パラメーターをセット
        AcceptanceInspectionAnalyze.parameter  = "&targetID="   + document.getElementById("targetID").value;
        AcceptanceInspectionAnalyze.parameter  += "&targetCategory="   + document.getElementById("targetCategory")[document.getElementById("targetCategory").selectedIndex].value;
        // Ajax通信
        AcceptanceInspectionAnalyze.AjaxLoadTable("ConfirmID", "GetIDName", "showIDName");
        return false;
    default:
