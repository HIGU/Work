...
?>
    <?php if ($rows >= 1) { ?>
        ...
        <?php for ($r=0; $r<$rows; $r++) { ?>
            ...
            <!-- プログラム名 -->
            <td class='winbox' align='left' nowrap><%=mb_convert_encoding($res[$r][1], 'UTF-8', 'EUC-JP')%></td>
            <!-- ディレクトリ -->
            <td class='winbox' align='left' nowrap><%=mb_convert_encoding($res[$r][2], 'UTF-8', 'EUC-JP')%></td>
            </tr>
            <tr>
            ...
            <tr>
            <!-- コメント -->
            <td class='winbox' align='left' colspan='2' nowrap><%=mb_convert_encoding($res[$r][3], 'UTF-8', 'EUC-JP')%></td>
            <?php
            $db_use = 0;
            for ($i=4; $i<16; $i++) {
                if ($res[$r][$i] != '') {
