...
////////////// サイト設定
$menu->set_site(3, 99);                    // site_index=30(生産メニュー) site_id=50(納入・検査仕掛)999(サイトを開く)
//////////// タイトル名(ソースのタイトル名とフォームのタイトル名)
$menu->set_title('社員メニュー');
//////////// フレームの呼出先のアクション(frame)名とアドレス設定
$menu->set_frame('Header', EMP . 'emp_menu.php');
$menu->set_frame('List'  , EMP . 'view_user_statistic.php');
