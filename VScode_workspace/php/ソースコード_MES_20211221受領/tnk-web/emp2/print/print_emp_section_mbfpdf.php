<?php
//////////////////////////////////////////////////////////////////////////////
// 社員情報管理の 社員名簿 部署別一覧表 ＰＤＦ出力(印刷) FPDF/MBFPDF 使用   //
// Copyright (C) 2004-2017 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2004/02/13 Created  print_emp_section_mbfpdf.php   ゴシック体            //
...
class PDF_j extends MBFPDF  // 日本語PDFクラスを拡張します。
{
    ...
    {
        $this->Image('/home/www/html/tnk-web/img/t_nitto_logo2.png', 150, 5, 50, 0, '', '');  //イメージを配置します。場所を指定します。→リファレンス参照
        $this->SetX(70);
        ...
        # $this->Cell(80);
        //Framed title
        $this->Cell(70,10,'社員名簿　部署別一覧表','TB',0,'C');
        $this->Ln(15);
...
// $pdf->AddFont('times' ,'I');  // AddFont('times', 'I', 'timesi.php');と同じ意味 CoreFontは必要ない
$pdf->Open();           // PDFを開始
...
$sql = "select trim(section_name) as section
        ...
        order by sid ASC, pid DESC, uid ASC";
