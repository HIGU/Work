<?php
//////////////////////////////////////////////////////////////////////////////
// 就業週報の集計 結果 照会                           Client interface 部   //
...
require_once ('working_hours_report_Controller.php');   // MVC の Controller部
require_once ('working_hours_report_Model.php');        // MVC の Model部
...
function main()
{
    ...
    ////////////// サイト設定
    $menu->set_site(INDEX_EMP, 6);          // site_index=INDEX_INDUST(生産メニュー) site_id=17(出庫集計)999(サイトを開く)
    ////////////// リターンアドレス設定
    $menu->set_RetUrl(EMP_MENU);             // 通常は指定する必要はない
