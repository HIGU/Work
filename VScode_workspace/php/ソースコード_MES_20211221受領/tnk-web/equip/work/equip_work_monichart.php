<?php
//////////////////////////////////////////////////////////////////////////////
// 組立機械稼動管理システムの 運転状況表の 表示  フレーム定義               //
// Copyright (C) 2021-2021 norihisa_ooya@nitto-kohki.co.jp                  //s
// Changed history                                                          //
// 2021/03/26 Created  equip_work_monichart.php                             //
//////////////////////////////////////////////////////////////////////////////
...
$menu->set_frame('Header', EQUIP2 . 'work/equip_work_monichartHeader.php');
$menu->set_frame('List'  , EQUIP2 . 'work/equip_work_monichartList.php');
