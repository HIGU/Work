<?php
//////////////////////////////////////////////////////////////////////////////
// 組立機械稼動管理システムの 実績(履歴)データ グラフ 表示  フレーム定義    //
// Copyright (C) 2021-2021 norihisa_ooya@nitto-kohki.co.jp                  //
// Changed history                                                          //
// 2021/03/26 Created  equip_hist_graph_moni.php                            //
//////////////////////////////////////////////////////////////////////////////
...
$menu->set_frame('Header', EQUIP2 . 'hist/equip_hist_graph_moniHeader.php');
$menu->set_frame('List'  , EQUIP2 . 'hist/equip_hist_graph_moniList.php');
