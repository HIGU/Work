...
function doDecision() {
    var Gokei   = document.MainForm.GOKEI.value * 1;
    var PlanNum = document.MainForm.PlanNum.value * 1;
    if (Gokei > PlanNum) {
                            ...
                            <td class='LAYOUT'>
                                <table border='1'>
                                    ...
                                    <tr>
                                        ...
                                        <td align='center'>
                                            <input type='text' name='Today' size='6' maxlength='6' value='<?=outHtml(@$Report['Today'])?>' class='READONLY' onChange='CalOkNum()' style='text-align: right;' readonly>
                                        </td>
                                        <td align='center'>
