<?php 
//////////////////////////////////////////////////////////////////////////////
// 設備稼働管理システムの機械運転日報 日報修正フォーム                      //
// Copyright (C) 2004-2006 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Original by yamagishi@matehan.co.jp                                      //
// Changed history                                                          //
// 2004/07/15 Created  ReportEdit.php                                       //
// 2006/04/21 <br>を削除してレイアウトをReportView.phpに合わせる            //
//            切断材の場合の良品数・不良数のチェックをし材料投入数を変更    //
// 2006/04/26 hidden に Type を追加                                         //
// 2006/05/02 上記の不良数に加え段取数も材料投入数に反映するように変更      //
//////////////////////////////////////////////////////////////////////////////
...
<?php if (@$Report['ENTRY_LEVEL'] == 1) { ?>
                    ...
                    <table border='1'>
                        <tr>
                            ...
                            <td align='center' style='width:100;'>
                                <input type='text' name='SijiNo' size='6' maxlength='6' value='<?=outHtml(@$Report['SijiNo'])?>' class='NUM'>
                            </td>
                        </tr>
                        <tr>
                            <td class='HED' style='width:80;'>
                        ...
                        <tr class='LAYOUT'>
                            <td class='LAYOUT' valign='top'>
                                <table border='1' style='width:390;'>
                                    ...
                                    <tr>
                                        <td align='center'>
                                            <input type='text' name='Yesterday' size='6' maxlength='6' value='<?=outHtml(@$Report['Yesterday'])?>' class='NUM' onChange='CalOkNum()'>
                                        </td>
                                        <td align='center'>
