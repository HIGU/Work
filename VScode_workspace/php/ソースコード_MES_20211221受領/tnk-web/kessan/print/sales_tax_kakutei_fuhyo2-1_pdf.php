<?php
//////////////////////////////////////////////////////////////////////////////////
// ·î¼¡Â»±×´Ø·¸ ¾ÃÈñÀÇ¿½¹ð½ñ ³ÎÄê¿½¹ð½ñÉÕÉ½2-(1) PDF½ÐÎÏ(°õºþ) FPDF/MBFPDF»ÈÍÑ  //
// Copyright (C) 2021-2021 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp        //
// Changed history                                                              //
// 2019/06/13 Created  sales_tax_kakutei_fuhyo1-1_pdf  ¥´¥·¥Ã¥¯ÂÎ               //
//////////////////////////////////////////////////////////////////////////////////
...
class PDF_j extends MBFPDF  // ÆüËÜ¸ìPDF¥¯¥é¥¹¤ò³ÈÄ¥¤·¤Þ¤¹¡£
{
    ...
    function Header()   //Æ¬¤Ë¤Ä¤±¤¿¤¤ÆâÍÆ¤Ï¤³¤³¤Ë¡£¥³¥ó¥¹¥È¥é¥¯¥¿¤ß¤¿¤¤¤Ë¼«Æ°¼Â¹Ô¤µ¤ì¤Þ¤¹¡£
    {
        ...
        */
        ...
        /// $this->Cell(80);
        // Framed title
        $list_title = 'ÉÕÉ½£²-¡Ê£±¡Ë ²ÝÀÇÇä¾å³ä¹ç¡¦¹µ½üÂÐ¾Ý»ÅÆþÀÇ³ÛÅù¤Î·×»»É½';
        $this->Cell(80, 10, $list_title, 'TB', 0, 'C');
        $this->Ln();    // ²þ¹Ô
        $list_title2 = ' ¡Ì·Ð²áÁ¼ÃÖÂÐ¾Ý²ÝÀÇ»ñ»º¤Î¾ùÅÏ¤ò´Þ¤à²ÝÀÇ´ü´ÖÍÑ¡Í';
        $this->Cell(180, 10, $list_title2, 'TB', 0, 'C');
        /*
        $this->Ln(80);
...
$data_f = array();  // ¥¹¥«¥é¡¼ÊÑ¿ô¤Ç¤Ï¤Ê¤¯¤Æ¡¢ÇÛÎó¤À¤È¤¤¤¦¤³¤È¤òÌÀ¼¨
    // Column titles
    $pdf->wh_usr = array('¹à', '', 'ÌÜ', 'µìÀÇÎ¨Ê¬¾®·×£Ø', 'ÀÇÎ¨6.24¡óÅ¬ÍÑÊ¬£Ä', 'ÀÇÎ¨7.8¡óÅ¬ÍÑÊ¬£Å', '¶â³Û£Æ¡Ê£Ø+£Ä+£Å¡Ë');
    $pdf->w_usr  = array(15, 65, 7, 20, 30, 26, 28);   //³Æ¥»¥ë¤Î²£Éý¤ò»ØÄê¤·¤Æ¤¤¤Þ¤¹¡£
    /* ¼õ¹ÖÍúÎò¤ò¼èÆÀ SQL */
    $res_w = array();
    ...
    $s_1 = '';
    $s_2 = 'Èó²ÝÀÇ»ñ»º¤ÎÍ¢½ÐÅù¤Î¶â³Û¡¢³¤³°»ÙÅ¹Åù¤Ø°ÜÁ÷¤·¤¿»ñ»º¤Î²Á³Û';
    $s_3 = '­£';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '';
    $s_2 = '²ÝÀÇ»ñ»º¤Î¾ùÅÏÅù¤ÎÂÐ²Á¤Î³Û¡Ê­¡+­¢+­£¡Ë';
    $s_3 = '­¤';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '';
    $s_2 = '²ÝÀÇ»ñ»º¤Î¾ùÅÏÅù¤ÎÂÐ²Á¤Î³Û¡Ê­¤¤Î¶â³Û¡Ë';
    $s_3 = '­¥';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '';
    $s_2 = '²ÝÀÇ»ÅÆþ¤ì¤Ë·¸¤ë»ÙÊ§ÂÐ²Á¤Î³Û¡ÊÀÇ¹þ¤ß¡Ë';
    $s_3 = '­©';
    $s_4 = '20,821,441';
    $s_5 = '155,640';
    $s_6 = '4,985,324,781';
    ...
    $s_1 = '';
    $s_2 = 'ÆÃÄê²ÝÀÇ»ÅÆþ¤ì¤Ë·¸¤ë»ÙÊ§ÂÐ²Á¤Î³Û';
    $s_3 = '­«';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '';
    $s_2 = 'ÆÃÄê²ÝÀÇ»ÅÆþ¤ì¤Ë·¸¤ë¾ÃÈñÀÇ³Û';
    $s_3 = '­¬';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = 'Ç¼ÀÇµÁÌ³¤ÎÌÈ½ü¤ò¼õ¤±¤Ê¤¤¡Ê¼õ¤±¤ë¡Ë¤³¤È¤È¤Ê¤Ã¤¿';
    $s_2 = '¾ì¹ç¤Ë¤ª¤±¤ë¾ÃÈñÀÇ³Û¤ÎÄ´À°¡Ê²Ã»»Ëô¤Ï¸º»»¡Ë³Û';
    $s_3 = '­®';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '';
    $s_2 = '²ÝÀÇ»ÅÆþ¤ìÅù¤ÎÀÇ³Û¤Î¹ç·×³Û¡Ê­ª+­¬+­­¡Þ­®¡Ë';
    $s_3 = '­¯';
    $s_4 = '1,214,584';
    $s_5 = '8,992';
    $s_6 = '356,616,424';
    ...
    $s_1 = '²ÝÀÇÇä¾å¹â¤¬5²¯±ß°Ê²¼¡¢¤«¤Ä¡¢';
    $s_2 = '²ÝÀÇÇä¾å³ä¹ç¤¬95¡ó°Ê¾å¤Î¾ì¹ç¡Ê­¯¤Î¶â³Û¡Ë';
    $s_3 = '­°';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '5²¯±ßÄ¶Ëô';
    $s_2 = '­¯¤Î¤¦¤Á¡¢²ÝÀÇÇä¾å¤²¤ÈÈó²ÝÀÇÇä¾å¤Ë¶¦ÄÌ¤·¤ÆÍ×¤¹¤ë¤â¤Î';
    $s_3 = '­²';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '²ÝÀÇÇä¾å³ä¹ç¤¬';
    $s_2 = '¸ÄÊÌÂÐ±þÊý¼°¤Ë¤è¤ê¹µ½ü¤¹¤ë²ÝÀÇ»ÅÆþ¤ìÅù¤ÎÀÇ³Û¡Ì­±¡Ü¡Ê­²¡ß­¤¡¿­§¡Ë¡Í';
    $s_3 = '­³';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = '95¡óÌ¤Ëþ¤Î¾ì¹ç';
    $s_2 = '°ì³çÈæÎãÇÛÊ¬Êý¼°¤Ë¤è¤ê¹µ½ü¤¹¤ë²ÝÀÇ»ÅÆþ¤ìÅù¤ÎÀÇ³Û¡Ê­¯¡ß­¤/­§¡Ë';
    $s_3 = '­´';
    $s_4 = '1,214,517';
    $s_5 = '8,991';
    $s_6 = '356,596,992';
    ...
    $s_1 = '¹µ½ü';
    $s_2 = '²ÝÀÇÇä¾å³ä¹çÊÑÆ°»þ¤ÎÄ´À°ÂÐ¾Ý¸ÇÄê»ñ»º¤Ë·¸¤ë¾ÃÈñÀÇ³Û¤ÎÄ´À°¡Ê²Ã»»Ëô¤Ï¸º»»¡Ë³Û';
    $s_3 = '21';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = 'ÀÇ³Û¤Î';
    $s_2 = 'Ä´À°ÂÐ¾Ý¸ÇÄê»ñ»º¤ò²ÝÀÇ¶ÈÌ³ÍÑ¡ÊÈó²ÝÀÇ¶ÈÌ³ÍÑ¡Ë¤ËÅ¾ÍÑ¤·¤¿¾ì¹ç¤ÎÄ´À°¡Ê²Ã»»Ëô¤Ï¸º»»¡Ë³Û';
    $s_3 = '22';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = 'Ä´À°';
    $s_2 = 'µï½»ÍÑÄÂÂß·úÊª¤ò²ÝÀÇÄÂÂßÍÑ¤Ë¶¡¤·¤¿¡Ê ¾ùÅÏ¤·¤¿¡Ë ¾ì¹ç¤Î²Ã»»³Û';
    $s_3 = '23';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
    ...
    $s_1 = 'º¹';
    $s_2 = '¹µ½üÂÐ¾Ý»ÅÆþÀÇ³Û¡Ì¡Ê­°¡¢­³Ëô¤Ï­´¤Î¶â³Û¡Ë¡Þ?¡Þ?¡Ü?¡Í¤¬¥×¥é¥¹¤Î»þ';
    $s_3 = '24';
    $s_4 = '1,214,517';
    $s_5 = '8,991';
    $s_6 = '356,596,992';
    ...
    $s_1 = '°ú';
    $s_2 = '¹µ½ü²áÂçÄ´À°ÀÇ³Û¡Ì(­°¡¢­³Ëô¤Ï­´¤Î¶â³Û)¡Þ?¡Þ?¡Ü?¡Í¤¬¥Þ¥¤¥Ê¥¹¤Î»þ';
    $s_3 = '25';
    $s_4 = '';
    $s_5 = '';
    $s_6 = '';
