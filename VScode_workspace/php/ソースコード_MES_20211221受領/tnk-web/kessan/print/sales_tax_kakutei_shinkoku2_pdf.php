<?php
//////////////////////////////////////////////////////////////////////////////
// ·î¼¡Â»±×´Ø·¸ ¾ÃÈñÀÇ¿½¹ð½ñ ³ÎÄê¿½¹ð½ñÂè2É½ PDF½ÐÎÏ(°õºþ) FPDF/MBFPDF»ÈÍÑ  //
...
class PDF_j extends MBFPDF  // ÆüËÜ¸ìPDF¥¯¥é¥¹¤ò³ÈÄ¥¤·¤Þ¤¹¡£
{
    ...
    function Header()   //Æ¬¤Ë¤Ä¤±¤¿¤¤ÆâÍÆ¤Ï¤³¤³¤Ë¡£¥³¥ó¥¹¥È¥é¥¯¥¿¤ß¤¿¤¤¤Ë¼«Æ°¼Â¹Ô¤µ¤ì¤Þ¤¹¡£
    {
        ...
        */
        ...
        /// $this->Cell(80);
        // Framed title
        $list_title = '²ÝÀÇÉ¸½à³ÛÅù¤ÎÆâÌõ½ñ ²ÝÀÇ´ü´ÖÊ¬¤Î¾ÃÈñÀÇµÚ¤ÓÃÏÊý¾ÃÈñÀÇ¤Î³ÎÄê¿½¹ð½ñ';
...
$data_f = array();  // ¥¹¥«¥é¡¼ÊÑ¿ô¤Ç¤Ï¤Ê¤¯¤Æ¡¢ÇÛÎó¤À¤È¤¤¤¦¤³¤È¤òÌÀ¼¨
    ...
    $s_1 = 'ÆÃÄê²ÝÀÇ»ÅÆþ¤ì¤Ë·¸¤ë';
    $s_2 = '»ÙÊ§ÂÐ²Á¤Î³Û¤Î¹ç·×³Û';
    $s_3 = '­ª';
    $s_4 = '';
    ...
    $s_1 = '­±¤Î';
    $s_2 = 'Çä¾å¤²¤ÎÊÖ´ÔÅùÂÐ²Á¤Ë·¸¤ëÀÇ³Û';
    $s_3 = '­²';
    $s_4 = '';
    $data_f[18] = array($s_1, $s_2, $s_3, $s_4);
    
    $s_1 = 'ÆâÌõ';
    $s_2 = 'ÆÃÄê²ÝÀÇ»ÅÆþ¤ì¤ÎÊÖ´ÔÅùÂÐ²Á¤Ë·¸¤ëÀÇ³Û';
    $s_3 = '­³';
    $s_4 = '';
    $data_f[19] = array($s_1, $s_2, $s_3, $s_4);
    
    $s_1 = 'ÃÏÊýÊý¾ÃÈñÀÇ¤Î²ÝÀÇ';
    $s_2 = 'É¸½à¤È¤Ê¤ë¾ÃÈñÀÇ³Û';
    $s_3 = '­´';
    $s_4 = '44,615,352';
