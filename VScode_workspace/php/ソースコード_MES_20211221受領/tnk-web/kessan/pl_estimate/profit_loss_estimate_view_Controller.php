<?php
//////////////////////////////////////////////////////////////////////////////
// 損益予測の集計・分析 結果 照会(照会のみ）             MVC Controller 部  //
// Copyright (C) 2011-     Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2011/07/19 Created   profit_loss_estimate_view_Controller.php            //
//////////////////////////////////////////////////////////////////////////////
...
class ProfitLossEstimate_Controller
{
    ...
    ************************************************************************/
    ...
    public function display()
    {
        ...
        case 'Comment':                                     // 別ウィンドウでコメントの照会・編集
            ...
            require_once ('profit_loss_estimate_view_ViewEditComment.php');
            break;
        }
    }
    ...
    ***************************************************************************/
    ...
    {
        require_once ('profit_loss_estimate_view_ViewCondForm.php');
        return true;
    }
    ...
    private function ViewListExecute($menu, $request, $model, $uniq)
    {
        ...
        case 'List':
            require_once ('profit_loss_estimate_view_ViewListAjax.php');
            break;
        case 'ListWin':
        default:
            require_once ('profit_loss_estimate_view_ViewListWin.php');
        }
        return true;
    }
