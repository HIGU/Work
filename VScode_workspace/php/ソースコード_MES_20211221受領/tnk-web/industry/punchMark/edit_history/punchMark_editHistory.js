//////////////////////////////////////////////////////////////////////////////
// 刻印管理システム 編集履歴メニュー           MVC View部(JavaScriptクラス) //
// Copyright (C) 2007      Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2007/11/15 Created   punchMark_editHistory.js                            //
// 2007/11/15 AjaxのGETメソッドはSJIS→EUC-JPへ POSTメソッドはUTF-8→EUC-JP //
//////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************
/*        punchMark_editHistory class base_class の拡張クラスの定義         *
/****************************************************************************
class punchMark_editHistory extends base_class
*/
///// スーパークラスの継承
punchMark_editHistory.prototype = new base_class();    // base_class の継承
///// Constructer の定義
function punchMark_editHistory()
{
    /***********************************************************************
    *                           Private properties                         *
    ***********************************************************************/
    ...
    ************************************************************************/
    ...
    punchMark_editHistory.prototype.set_focus = function (obj, status)
    {
        if (obj) {
            obj.focus();
    ...
    punchMark_editHistory.prototype.blink_disp = function (id_name)
    {
    ...
    /***** 点滅ストップメソッド *****/
    punchMark_editHistory.prototype.stop_blink = function ()
    {
    ...
    /***** オブジェクトの値を大文字変換する *****/
    punchMark_editHistory.prototype.obj_upper = function (obj)
    {
    ...
    punchMark_editHistory.prototype.win_open = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    punchMark_editHistory.prototype.winActiveChk = function ()
    {
    ...
    punchMark_editHistory.prototype.win_show = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    punchMark_editHistory.prototype.dateCreate = function (obj)
    {
    ...
    punchMark_editHistory.prototype.checkConditionForm = function (obj)
    {
        /************
    ...
    punchMark_editHistory.prototype.checkANDexecute = function (obj, flg)
    {
        var result = true;
    ...
    punchMark_editHistory.prototype.AjaxLoadTable = function (showMenu, location)
    {
        ...
        if (showMenu == "ListWin") {    // 別ウィンドウで表示
            this.win_open("punchMark_editHistory_Main.php"+parm, 900, 700);
            return true;
        }
        /***
        ...
        ***/
        ...
        try {
            /***** GETメソッドを使用する場合
            xmlhttp.open("GET", "punchMark_editHistory_Main.php" + parm, true);  // true=Ajaxの本領 非同期通信を行う。指定しなければtrue
            ...
            *****/
            xmlhttp.open("POST", "punchMark_editHistory_Main.php", true);
    ...
    /***** 結果表示領域のクリアーメソッド *****/
    punchMark_editHistory.prototype.viewClear = function ()
    {
    ...
    punchMark_editHistory.prototype.WaitMessage = function ()
    {
...
}   /* class punchMark_editHistory END  */


///// インスタンスの生成
var PunchMarkEditHistory = new punchMark_editHistory();
