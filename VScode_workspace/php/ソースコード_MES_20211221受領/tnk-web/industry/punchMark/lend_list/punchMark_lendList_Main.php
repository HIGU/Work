<?php
//////////////////////////////////////////////////////////////////////////////
// 刻印管理システム 貸出台帳メニュー                  Client interface 部   //
//                                              MVC Controller の Main 部   //
// Copyright (C) 2007      Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2007/11/16 Created   punchMark_lendList_Main.php                         //
//////////////////////////////////////////////////////////////////////////////
...
require_once ('punchMark_lendList_Controller.php'); // MVC の Controller部
require_once ('punchMark_lendList_Model.php');      // MVC の Model部
...
function main()
{
    ...
    $title = '刻印管理システム 貸出台帳メニュー';
    $menu->set_title($title);
    //////////// 呼出先のaction名とアドレス設定
    // $menu->set_action('引当構成表',   INDUST . 'material/allo_conf_parts_view.php');
    
    //////////// コントローラー部のインスタンス生成
    $controller = new PunchMarkLendList_Controller($menu);
