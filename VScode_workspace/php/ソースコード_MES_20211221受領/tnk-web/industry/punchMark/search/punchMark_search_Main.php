<?php
//////////////////////////////////////////////////////////////////////////////
// 刻印管理システム 検索メニュー                      Client interface 部   //
//                                              MVC Controller の Main 部   //
// Copyright (C) 2007      Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2007/10/22 Created   punchMark_search_Main.php                           //
//////////////////////////////////////////////////////////////////////////////
...
require_once ('punchMark_search_Controller.php');   // MVC の Controller部
require_once ('punchMark_search_Model.php');        // MVC の Model部
...
function main()
{
    ...
    //////////// コントローラー部のインスタンス生成
    $controller = new PunchMarkSearch_Controller($menu);
