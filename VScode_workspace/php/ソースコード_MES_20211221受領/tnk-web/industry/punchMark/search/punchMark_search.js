//////////////////////////////////////////////////////////////////////////////
// 刻印管理システム 検索メニュー               MVC View部(JavaScriptクラス) //
// Copyright (C) 2007      Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2007/11/13 Created   punchMark_search.js                                 //
// 2007/11/14 AjaxのGETメソッドはSJIS→EUC-JPへ POSTメソッドはUTF-8→EUC-JP //
//////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************
/*           punchMark_search class base_class の拡張クラスの定義           *
/****************************************************************************
class punchMark_search extends base_class
*/
///// スーパークラスの継承
punchMark_search.prototype = new base_class();    // base_class の継承
///// Constructer の定義
function punchMark_search()
{
    /***********************************************************************
    *                           Private properties                         *
    ***********************************************************************/
    ...
    ************************************************************************/
    ...
    punchMark_search.prototype.set_focus = function (obj, status)
    {
        if (obj) {
            obj.focus();
    ...
    punchMark_search.prototype.blink_disp = function (id_name)
    {
    ...
    /***** 点滅ストップメソッド *****/
    punchMark_search.prototype.stop_blink = function ()
    {
    ...
    /***** オブジェクトの値を大文字変換する *****/
    punchMark_search.prototype.obj_upper = function (obj)
    {
    ...
    punchMark_search.prototype.win_open = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    punchMark_search.prototype.winActiveChk = function ()
    {
    ...
    punchMark_search.prototype.win_show = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    punchMark_search.prototype.dateCreate = function (obj)
    {
    ...
    punchMark_search.prototype.checkConditionForm = function (obj)
    {
        /************
    ...
    punchMark_search.prototype.checkANDexecute = function (obj, flg)
    {
        var result = true;
    ...
    punchMark_search.prototype.AjaxLoadTable = function (showMenu, location)
    {
        ...
        if (showMenu == "ListWin") {    // 別ウィンドウで表示
            this.win_open("punchMark_search_Main.php"+parm, 900, 700);
            return true;
        }
        /***
        ...
        ***/
        ...
        try {
            /***** GETメソッドを使用する場合
            xmlhttp.open("GET", "punchMark_search_Main.php" + parm, true);  // true=Ajaxの本領 非同期通信を行う。指定しなければtrue
            ...
            *****/
            xmlhttp.open("POST", "punchMark_search_Main.php", true);
    ...
    /***** 結果表示領域のクリアーメソッド *****/
    punchMark_search.prototype.viewClear = function ()
    {
    ...
    punchMark_search.prototype.WaitMessage = function ()
    {
...
}   /* class punchMark_search END  */


///// インスタンスの生成
var PunchMarkSearch = new punchMark_search();
