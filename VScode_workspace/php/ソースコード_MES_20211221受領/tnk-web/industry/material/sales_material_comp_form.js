//////////////////////////////////////////////////////////////////////////////
// 仕切単価と総材料費の比較表 (売上メニューのチェックルーチンをコピー)      //
//    JavaScript salse_form.js → sales_material_comp_form.js               //
// Copyright(C) 2004-2004 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp       //
// Changed history                                                          //
// 2004/05/12 Created  sales_material_comp_form.js                          //
//////////////////////////////////////////////////////////////////////////////
...
function chk_sales_form(obj) {
    ...
    if ( !isDigit(obj.sales_page.value) ) {
        ...
        obj.sales_page.select();
        return false;
    } else if (obj.sales_page.value > 999) {
        alert('ページ数は９９９までです！');
        obj.sales_page.focus();
        obj.sales_page.select();
        return false;
