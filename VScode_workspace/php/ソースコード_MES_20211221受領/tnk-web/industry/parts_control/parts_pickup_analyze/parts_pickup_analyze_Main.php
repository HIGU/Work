<?php
//////////////////////////////////////////////////////////////////////////////
// 資材出庫時間の集計･分析 結果 照会                  Client interface 部   //
//                                              MVC Controller の Main 部   //
// Copyright (C) 2006-2006 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2006/05/30 Created   parts_pickup_analyze_Main.php                       //
//////////////////////////////////////////////////////////////////////////////
...
require_once ('parts_pickup_analyze_Controller.php');   // MVC の Controller部
require_once ('parts_pickup_analyze_Model.php');        // MVC の Model部
...
function main()
{
    ...
    ////////////// サイト設定
    $menu->set_site(INDEX_INDUST, 17);          // site_index=INDEX_INDUST(生産メニュー) site_id=17(出庫集計)999(サイトを開く)
    ////////////// リターンアドレス設定
    ...
    //////////// コントローラー部のインスタンス生成
    $controller = new PartsPickupAnalyze_Controller($menu);
