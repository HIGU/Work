...
require_once ('assembly_time_compare_edit_Controller.php');  // MVC の Controller部
require_once ('assembly_time_compare_edit_Model.php');       // MVC の Model部
...
function main()
{
    ...
    //////////// コントローラー部のインスタンス生成
    $controller = new AssemblyTimeCompareEdit_Controller($menu);
