//////////////////////////////////////////////////////////////////////////////
// 組立の作業管理 着手・完了データ 照会用  MVC View 部 (JavaScriptクラス)   //
// Copyright (C) 2006-2006 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2006/01/19 Created    assembly_process_show.js                           //
// 2006/01/20 Ajax用のtable表示用メソッドの追加 AjaxLoadStart (着手一覧)    //
//////////////////////////////////////////////////////////////////////////////

/****************************************************************************
/*     assembly_process_show class テンプレートの拡張クラスの定義           *
/****************************************************************************
class assembly_process_show extends base_class
{   */
    ///// スーパークラスの継承
    assembly_process_show.prototype = new base_class();   // base_class の継承
    ...
    function assembly_process_show()
    {
        ...
        *                           Public methods                              *
        ************************************************************************/
        assembly_process_show.prototype.set_focus           = set_focus;            // 指定の入力エレメントにフォーカス
        assembly_process_show.prototype.blink_disp          = blink_disp;           // 点滅表示メソッド
        assembly_process_show.prototype.obj_upper           = obj_upper;            // オブジェの値を大文字変換
        assembly_process_show.prototype.win_open            = win_open;             // サブウィンドウを中央に表示
        assembly_process_show.prototype.winActiveChk        = winActiveChk;         // サブウィンドウのActiveチェック
        assembly_process_show.prototype.win_show            = win_show;             // モーダルダイアログを表示(IE専用)
        assembly_process_show.prototype.checkInputForm      = checkInputForm;       // 入力フォームの入力チェックメソッド
        assembly_process_show.prototype.AjaxLoadStart       = AjaxLoadStart;        // Ajaxを使用した着手一覧リロード用実行メソッド
    ...
    {
        var parm = "?";
        parm += "&showMenu=StartTable"  // tableのみ抽出
