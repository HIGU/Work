<?php
//////////////////////////////////////////////////////////////////////////////
// 集荷納期の照会 次工程品(注文書未発行分) 明細をウィンドウ表示 フレーム定義//
// Copyright (C) 2017-2017 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2017/07/27 Created  order_collect_next.php(order_details_next.phpを改造) //
//////////////////////////////////////////////////////////////////////////////
...
$menu->set_frame('Header', INDUST . 'order/order_details/order_collect_next_Header.php');
$menu->set_frame('List'  , INDUST . 'order/order_details/order_collect_next_List.php');
...
if ($date == 'OLD') {
    $menu->set_title('次工程 集荷納期の明細 照会');    // タイトルを入れないとIEの一部のバージョンで表示できない不具合あり
} else {
    $menu->set_title("{$_REQUEST['date']} 集荷納期 次工程 明細の照会"); // タイトルを入れないとIEの一部のバージョンで表示できない不具合あり
}
