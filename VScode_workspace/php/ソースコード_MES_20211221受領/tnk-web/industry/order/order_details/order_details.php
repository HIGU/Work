...
// Changed history                                                          //
// 2004/09/30 Created  order_details.php                                    //
...
$menu->set_frame('Header', INDUST . 'order/order_details/order_details_Header.php');
$menu->set_frame('List'  , INDUST . 'order/order_details/order_details_List.php');
