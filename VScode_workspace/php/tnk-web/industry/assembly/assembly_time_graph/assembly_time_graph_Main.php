<?php
//////////////////////////////////////////////////////////////////////////////
// 組立のライン別工数 各種グラフ                      Client interface 部   //
...
require_once ('assembly_time_graph_Controller.php');    // MVC の Controller部
require_once ('assembly_time_graph_Model.php');         // MVC の Model部
...
function main()
{
    ...
    ////////////// サイト設定
    $menu->set_site(INDEX_INDUST, 15);          // site_index=INDEX_INDUST(生産メニュー) site_id=15(工数グラフ)999(サイトを開く)
    ////////////// リターンアドレス設定
