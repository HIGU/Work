...
// Changed history                                                          //
// 2021/12/20 Created   assembly_schedule_show_ViewListCsv                  //
//////////////////////////////////////////////////////////////////////////////
...
// ファイル名とSQLのサーチ部を受け取る
$outputFile = '組立日程計画一覧.csv';
$search = $_GET['csvsearch'];
$order = $_GET['csvorder'];
...
if (($rows_csv = getResultWithField3($query_csv, $field_csv, $res_csv)) <= 0) {
    ...
    for ($r=0; $r<$rows_csv; $r++) {
        ...
        $res_csv[$r][2] = str_replace(',',' ',$res_csv[$r][2]);                   // 製品名に,が入っているとCSVで桁がずれるので半角スペースに
        $res_csv[$r][8] = str_replace(',',' ',$res_csv[$r][8]);                   // 備考に,が入っているとCSVで桁がずれるので半角スペースに
