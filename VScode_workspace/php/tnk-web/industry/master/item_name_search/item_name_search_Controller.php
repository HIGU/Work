...
class ItemNameSearch_Controller
{
    ...
    ***************************************************************************/
    ...
    private function InitTargetItemName()
    {
        ...
        $targetItemName = mb_convert_encoding($this->request->get('targetItemName'), 'UTF-8', 'SJIS');
    ...
    {
        // Ajaxで送信された２バイト文字のSJISをEUC-JPへ変換
        $targetItemMaterial = mb_convert_encoding($this->request->get('targetItemMaterial'), 'UTF-8', 'SJIS');
        // 半角カナを全角カナ(濁点を１文字)へ変換
