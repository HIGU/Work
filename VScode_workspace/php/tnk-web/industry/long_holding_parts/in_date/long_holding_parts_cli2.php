...
<?php
//////////////////////////////////////////////////////////////////////////////
// 長期滞留部品の日報処理１年前の入庫品が在庫になっている物をワークへ抽出   //
// Copyright (C) 2006-2006 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2006/03/31 Created  long_holding_parts_cli2.php                          //
// 2006/04/02 work1/work2/work3 3/5/7年前 → work1 1年前のまとめ抽出へ変更  //
//////////////////////////////////////////////////////////////////////////////
...
if ( !($con = funcConnect()) ) {
    ...
    fwrite($fp, "$log_date 長期滞留部品のワークへ抽出を開始します。\n");
}

///// ここで未登録のリストをDBより取得して配列に格納する
///// 配列のフィールドは assy_no, plan_no, 売上日
$date1 = (date('Y') - 1) . date('md');  // 3年前 → 1年前へ変更
