...
// Changed history                                                          //
// 2005/01/18 Created  sales_custom_form.js                                 //
// 2006/08/29 各 上限値・下限値の入力有り無しチェックを追加                 //
//////////////////////////////////////////////////////////////////////////////
...
function chk_select_form(obj) {
    ...
    if ( upper_equal < lower_equal) {
        alert("総材料費と仕切単価が同じと判断する率の上限値が下限値より小さいです。");
        obj.lower_equal_ritu.focus();
        obj.lower_equal_ritu.select();
        return false;
    }
