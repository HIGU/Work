...
// Changed history                                                          //
// 2011/07/19 Created    profit_loss_estimate.js                            //
//////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************
/*     profit_loss_estimate class base_class の拡張クラスの定義             *
/****************************************************************************
class profit_loss_estimate extends base_class
*/
///// スーパークラスの継承
profit_loss_estimate.prototype = new base_class();    // base_class の継承
///// Constructer の定義
function profit_loss_estimate()
{
    /***********************************************************************
    *                           Private properties                         *
    ***********************************************************************/
    ...
    ************************************************************************/
    ...
    profit_loss_estimate.prototype.set_focus = function (obj, status)
    {
        if (obj) {
            obj.focus();
    ...
    profit_loss_estimate.prototype.blink_disp = function (id_name)
    {
    ...
    /***** 点滅ストップメソッド *****/
    profit_loss_estimate.prototype.stop_blink = function ()
    {
    ...
    /***** オブジェクトの値を大文字変換する *****/
    profit_loss_estimate.prototype.obj_upper = function (obj)
    {
    ...
    profit_loss_estimate.prototype.win_open = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    profit_loss_estimate.prototype.winActiveChk = function ()
    {
    ...
    profit_loss_estimate.prototype.win_show = function (url, w, h)
    {
        if (!w) w = 800;     // 初期値
        if (!h) h = 600;     // 初期値
    ...
    profit_loss_estimate.prototype.dateCreate = function (obj)
    {
    ...
    profit_loss_estimate.prototype.checkConditionForm = function (obj)
    {
    ...
    profit_loss_estimate.prototype.checkANDexecute = function (obj, flg)
    {
    ...
    profit_loss_estimate.prototype.AjaxLoadTable = function (showMenu, location)
    {
        ...
        if (showMenu == "ListWin") {    // 別ウィンドウで表示
            this.win_open("profit_loss_estimate_Main.php"+parm, 700, 350);
            return;
        }
        /***
        ...
        ***/
        ...
        try {
            xmlhttp.open("GET", "profit_loss_estimate_Main.php"+parm);
            xmlhttp.send(null);
        } catch (e) {
            alert(url + "\n\nをオープン出来ません！\n\n" + e);
        }
    ...
    /***** 結果表示領域のクリアーメソッド *****/
    profit_loss_estimate.prototype.viewClear = function ()
    {
    ...
    profit_loss_estimate.prototype.WaitMessage = function ()
    {
...
}   /* class profit_loss_estimate END  */


///// インスタンスの生成
var ProfitLossEstimate = new profit_loss_estimate();
