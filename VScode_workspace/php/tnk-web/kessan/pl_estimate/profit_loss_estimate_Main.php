<?php
//////////////////////////////////////////////////////////////////////////////
// 損益予測の集計・分析 結果 照会(都度照会)           Client interface 部   //
//                                              MVC Controller の Main 部   //
// Copyright (C) 2011-     Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2011/07/13 Created   profit_loss_estimate_Main.php                       //
...
require_once ('profit_loss_estimate_Controller.php');   // MVC の Controller部
require_once ('profit_loss_estimate_Model.php');        // MVC の Model部
