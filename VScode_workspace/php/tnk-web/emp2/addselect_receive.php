...
if (addselectReceive($_POST['rid'], $_POST['receive_name'], $_POST['rflg'])) {
    header('Location: ' . H_WEB_HOST . EMP . 'emp_menu.php?func=' . FUNC_CHGINDICATE . '#receive');
    exit();
}
$_SESSION['s_sysmsg'] .= '<br>　教育の項目 追加変更が出来ませんでした。';  // addselectReceiveでエラーの場合にメッセージがあるため.=に変更
header('Location: ' . H_WEB_HOST . EMP . 'emp_menu.php?func=' . FUNC_CHGINDICATE . '#receive');
?>
