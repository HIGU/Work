...
// Copyright (C) 2020-2021 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
...
/////////// begin トランザクション開始
$query = sprintf("SELECT DISTINCT admit_status FROM sougou_deteils WHERE admit_status !='END' and admit_status !='DENY' and admit_status !='CANCEL' and admit_status !='011061' ");
$res   = array();
$field = array();
