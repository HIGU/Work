...
fwrite($fpa, "/var/www/html/system/daily/as400get_ftp_re.php\n");
fwrite($fpa, "************************************************************************\n");
...
echo "/var/www/html/system/daily/as400get_ftp_re.php\n";
echo "************************************************************************\n";
...
/******** 引当部品データの更新 *********/
echo `/var/www/html/system/daily/allocated_parts_ftp.php`;
echo "------------------------------------------------------------------------\n";
...
/******** 内作指示のヘッダーと明細データの更新 *********/
echo `/var/www/html/system/daily/equip_work_inst_ftp.php`;
echo "------------------------------------------------------------------------\n";
...
/*
echo "総材料費の自動登録\n";
echo `/var/www/html/industry/material/material_auto_registry_cli.php`;
echo "------------------------------------------------------------------------\n";
*/

/******** 部品売上の材料費の自動登録 *********/
echo "部品売上の材料費の自動登録\n";
echo `/var/www/html/system/daily/parts_material_auto_registry_cli.php`;
echo "------------------------------------------------------------------------\n";
...
echo `/var/www/html/system/assembly_time/assembly_time_header_ftp_cli_once.php`;
echo "------------------------------------------------------------------------\n";
