...
/******** 引当データリアルタイム更新 *********/
`/var/www/html/system/daily/daily_allocated_cli.php`;
// echo `/var/www/html/system/daily/daily_allocated_cli.php`;
// echo "------------------------------------------------------------------------\n";

/******** 注文書発行データ更新 *********/
`/var/www/html/industry/order/order_data_daily_ftp_cli.php`;
// echo `/var/www/html/industry/order/order_data_daily_ftp_cli.php`;
// echo "------------------------------------------------------------------------\n";

/******** 日程計画ファイル更新 *********/
`/var/www/html/system/daily/plan_get_ftp.php`;
// echo `/var/www/html/system/daily/plan_get_ftp.php`;
// echo "------------------------------------------------------------------------\n";

/******** タイムカードのデータ更新 *********/
`/var/www/html/emp/timepro/timePro_update_cli.php`;
// echo `/var/www/html/emp/timepro/timePro_update_cli.php`;
// echo "------------------------------------------------------------------------\n";

/******** バケットマスターのデータ更新 *********/
`/var/www/html/system/daily/daily_backet_ftp_cli.php`;
// echo `/var/www/html/system/daily/daily_backet_ftp_cli.php`;
// echo "------------------------------------------------------------------------\n";
