...
<?php
//////////////////////////////////////////////////////////////////////////////
// 総材料費 データ 自動FTP UPLOAD CLI版                                     //
// Web Server (PHP) ----> AS/400                                            //
// 手動実行時はWebでこのPGMを実行後、ASで CALL PGM(GO1002) を実行           //
// 実行後、12→（GENKA）→01で製品番号で照会。                              //
// Copyright (C) 2010 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp         //
// Changed history                                                          //
// 2010/11/08 Created   material_cost--as400-upload_cli.php                 //
//////////////////////////////////////////////////////////////////////////////
