...
class CommonAuthority_Controller
{
    ...
    ***************************************************************************/
    ...
    private function InitTargetAuthName($request)
    {
        ...
        // $targetAuthName = mb_convert_encoding(stripslashes($_REQUEST['targetAuthName']), 'UTF-8', 'SJIS');
        $request->add('targetAuthName', mb_convert_encoding($request->get('targetAuthName'), 'UTF-8', 'SJIS'));
        return true;
    }
