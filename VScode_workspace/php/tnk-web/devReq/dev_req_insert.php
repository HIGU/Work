...
// 2004/02/24 メール本文の文字コードを UTF-8 から SJIS へ nkf -EsLw で変換 //
...
if ($rows_bangou=getResult($bangou_qry,$res_bangou)) {
    ...
    if (funcConnect()) {
        ...
        if (execQuery($insert_qry) >=0 ) {
            ...
            // $message = mb_convert_encoding($message, 'JIS', 'UTF-8');       // EUC-JPをJISへ変換
            // $add_head = mb_convert_encoding("From: tnksys@nitto-kohki.co.jp\r\nReply-To: tnksys@nitto-kohki.co.jp", 'JIS', 'UTF-8');       // EUC-JPをJISへ変換
