//////////////////////////////////////////////////////////////////////////////
// プログラム管理メニュー プログラムの検索     MVC View部(JavaScriptクラス) //
...
/****************************************************************************
/*           progMaster_search class base_class の拡張クラスの定義           *
/****************************************************************************
class progMaster_search extends base_class
*/
///// スーパークラスの継承
progMaster_search.prototype = new base_class();    // base_class の継承
///// Constructer の定義
    ...
    ************************************************************************/
    ...
    progMaster_search.prototype.AjaxLoadTable = function (showMenu, location)
    {
        ...
        ***/
        ...
        try {
            /***** GETメソッドを使用する場合
            xmlhttp.open("GET", "progMaster_search_Main.php" + parm, true);  // true=Ajaxの本領 非同期通信を行う。指定しなければtrue
