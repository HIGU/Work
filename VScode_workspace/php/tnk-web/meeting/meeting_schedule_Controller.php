...
class MeetingSchedule_Controller
{
    ...
    ************************************************************************/
    ...
    public function __construct($request, $model)
    {
        ...
        ///// 外出承認用
        $serial = $request->get('outing_serial');           // 承認する外出シリアル番号
        ...
        ///// 外出の承認
            ...
            $this->outingAdmit($request, $model);
        }
    }
    ...
    public function display($menu, $request, $result, $model)
    {
        ...
        case 'List':                                        // スケジュールの一覧 画面
            if( $request->get('only') == 'yes' ) {
                ...
                require_once ('meeting_schedule_ViewList.php');
            }
            break;
    ...
    ***************************************************************************/
    ...
    ///// 外出の承認 処理
    protected function outingAdmit($request, $model)
    {
        $response = $model->oadmit($request);
    }
