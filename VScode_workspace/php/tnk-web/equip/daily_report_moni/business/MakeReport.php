...
// Copyright (C) 2021-2022 norihisa_ooya@nitto-kohki.co.jp                  //
...
//            defineで0000に設定                                            //
// 2022/01/19 前日累計数が前日日付分を見てしまっていたのを同じ計画の        //
//            最大日付の物を見るように変更                             大谷 //
//////////////////////////////////////////////////////////////////////////////
...
function MakeHeaderRecode($row)
{
    ...
    $sql = " select yesterday + today as num from equip_work_report_moni "
         . " where  work_date<".mu_Date::addDay($Report['work_date'])." and mac_no=".$row['mac_no']." and plan_no='".$row['plan_no']."' and koutei=".$row['koutei']. " ORDER BY work_date DESC limit 1";
