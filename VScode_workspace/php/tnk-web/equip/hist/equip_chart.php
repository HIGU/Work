...
$menu->set_frame('Header', EQUIP2 . 'hist/equip_chartHeader.php');
$menu->set_frame('List'  , EQUIP2 . 'hist/equip_chartList.php');
// フレーム版は $menu->set_action()ではなく$menu->set_frame()を使用する

///// GET/POSTのチェック&設定
$key_no = '?mac_no=' . @$_REQUEST['mac_no'] . '&siji_no=' . @$_REQUEST['siji_no'] . '&koutei=' . @$_REQUEST['koutei'];
