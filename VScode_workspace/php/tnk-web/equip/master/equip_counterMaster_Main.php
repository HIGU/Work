...
// Changed history                                                          //
// 2005/07/15 Created   equip_counterMaster_Main.php                        //
...
require_once ('equip_counterMaster_Controller.php');// MVC の Controller部
require_once ('equip_counterMaster_Model.php');     // MVC の モデル部
...
////////////// サイト設定
$menu->set_site(40, 27);                    // site_index=40(設備メニュー) site_id=26(機械インターフェースマスター)
////////////// リターンアドレス設定
...
$menu->set_title("機械ワークカウンター マスターの照会・編集&nbsp;&nbsp;{$session->getFactName()}");

//////////// ビジネスモデル部のインスタンス生成
$model = new EquipCounterMaster_Model($session->get('factory'), $request);

//////////// コントローラー部のインスタンス生成
$controller = new EquipCounterMaster_Controller($menu, $request, $result, $model, $session);
