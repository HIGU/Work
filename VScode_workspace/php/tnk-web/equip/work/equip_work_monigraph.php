...
$menu->set_frame('Header', EQUIP2 . 'work/equip_work_monigraphHeader2.php');
$menu->set_frame('List'  , EQUIP2 . 'work/equip_work_monigraphList2.php');
/**
//if( $_SESSION['User_ID'] == '300667' ) {
if( $_SESSION['User_ID'] == '300667' || $_SESSION['User_ID'] == '300144' || $_SESSION['User_ID'] == '300594' ) {
    $menu->set_frame('Header', EQUIP2 . 'work/equip_work_monigraphHeader2.php');
    $menu->set_frame('List'  , EQUIP2 . 'work/equip_work_monigraphList2.php');
} else {
