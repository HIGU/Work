<?php
//////////////////////////////////////////////////////////////////////////////
// 機械稼動管理システムの 運転状況 グラフ 表示  フレーム定義                //
// Copyright (C) 2004-2004 Kazuhiro.Kobayashi tnksys@nitto-kohki.co.jp      //
// Changed history                                                          //
// 2004/08/09 Created  equip_work_graph.php                                 //
//////////////////////////////////////////////////////////////////////////////
...
$menu->set_frame('Header', EQUIP2 . 'work/equip_work_graphHeader.php');
$menu->set_frame('List'  , EQUIP2 . 'work/equip_work_graphList.php');
