<?php
//////////////////////////////////////////////////////////////////////////////
// ExcelファイルWeb表示用プログラム                                         //
//   defaultから変更する場合は664行目に以下を追加(元はコメント化)           //
//   $val = htmlentities($val,ENT_NOQUOTES, 'UTF-8');                       //
//   しないと文字化けをする。プログラム自体はEUCでLFにしてOK                //
//   470辺りで枠線を非表示にしている                                        //
// Copyright (C) 2020-2020 Norihisa.Ohya norihisa_ooya@nitto-kohki.co.jp    //
// Changed history                                                          //
// 2020/09/11 Created   excel_reader2.php                                   //
//////////////////////////////////////////////////////////////////////////////
// 以下元の説明文
/**
